...
Feature: JCVM Array Operation Bytecodes
  ...
  Scenario: newarray -- create new array of primitive type
    # Source: [JCVM 3.0.5, s7.5.71 newarray](../3.0.5/JCVMSpec_3.0.5.pdf#page=196)
    # Source: [JCVM 3.1, s7.5.71 newarray](../3.1/JCVMSpec_3.1.pdf#page=216)
    # Source: [JCVM 3.2, s7.5.71 newarray](../3.2/JCVMSpec_3.2.pdf#page=216)
  ...
  Scenario: anewarray -- create new array of reference type
    # Source: [JCVM 3.0.5, s7.5.6 anewarray](../3.0.5/JCVMSpec_3.0.5.pdf#page=146)
    # Source: [JCVM 3.1, s7.5.6 anewarray](../3.1/JCVMSpec_3.1.pdf#page=165)
    # Source: [JCVM 3.2, s7.5.6 anewarray](../3.2/JCVMSpec_3.2.pdf#page=165)
  ...
  Scenario: arraylength -- get length of array
    # Source: [JCVM 3.0.5, s7.5.8 arraylength](../3.0.5/JCVMSpec_3.0.5.pdf#page=147)
    # Source: [JCVM 3.1, s7.5.8 arraylength](../3.1/JCVMSpec_3.1.pdf#page=166)
    # Source: [JCVM 3.2, s7.5.8 arraylength](../3.2/JCVMSpec_3.2.pdf#page=166)
  ...
  Scenario: baload -- load byte or boolean from array
    # Source: [JCVM 3.0.5, s7.5.12 baload](../3.0.5/JCVMSpec_3.0.5.pdf#page=150)
    # Source: [JCVM 3.1, s7.5.12 baload](../3.1/JCVMSpec_3.1.pdf#page=169)
    # Source: [JCVM 3.2, s7.5.12 baload](../3.2/JCVMSpec_3.2.pdf#page=169)
  ...
  Scenario: bastore -- store into byte or boolean array
    # Source: [JCVM 3.0.5, s7.5.13 bastore](../3.0.5/JCVMSpec_3.0.5.pdf#page=151)
    # Source: [JCVM 3.1, s7.5.13 bastore](../3.1/JCVMSpec_3.1.pdf#page=169)
    # Source: [JCVM 3.2, s7.5.13 bastore](../3.2/JCVMSpec_3.2.pdf#page=169)
  ...
  Scenario: saload -- load short from array
    # Source: [JCVM 3.0.5, s7.5.84 saload](../3.0.5/JCVMSpec_3.0.5.pdf#page=207)
    # Source: [JCVM 3.1, s7.5.84 saload](../3.1/JCVMSpec_3.1.pdf#page=227)
    # Source: [JCVM 3.2, s7.5.84 saload](../3.2/JCVMSpec_3.2.pdf#page=227)
  ...
  Scenario: sastore -- store into short array
    # Source: [JCVM 3.0.5, s7.5.86 sastore](../3.0.5/JCVMSpec_3.0.5.pdf#page=208)
    # Source: [JCVM 3.1, s7.5.86 sastore](../3.1/JCVMSpec_3.1.pdf#page=228)
    # Source: [JCVM 3.2, s7.5.86 sastore](../3.2/JCVMSpec_3.2.pdf#page=228)
  ...
  Scenario: aaload -- load reference from array
    # Source: [JCVM 3.0.5, s7.5.1 aaload](../3.0.5/JCVMSpec_3.0.5.pdf#page=142)
    # Source: [JCVM 3.1, s7.5.1 aaload](../3.1/JCVMSpec_3.1.pdf#page=160)
    # Source: [JCVM 3.2, s7.5.1 aaload](../3.2/JCVMSpec_3.2.pdf#page=160)
  ...
  Scenario: aastore -- store into reference array
    # Source: [JCVM 3.0.5, s7.5.2 aastore](../3.0.5/JCVMSpec_3.0.5.pdf#page=143)
    # Source: [JCVM 3.1, s7.5.2 aastore](../3.1/JCVMSpec_3.1.pdf#page=161)
    # Source: [JCVM 3.2, s7.5.2 aastore](../3.2/JCVMSpec_3.2.pdf#page=161)
  ...
  Scenario: iaload -- load int from array
    # Source: [JCVM 3.0.5, s7.5.29 iaload](../3.0.5/JCVMSpec_3.0.5.pdf#page=164)
    # Source: [JCVM 3.1, s7.5.29 iaload](../3.1/JCVMSpec_3.1.pdf#page=183)
    # Source: [JCVM 3.2, s7.5.29 iaload](../3.2/JCVMSpec_3.2.pdf#page=183)
  ...
  Scenario: iastore -- store into int array
    # Source: [JCVM 3.0.5, s7.5.31 iastore](../3.0.5/JCVMSpec_3.0.5.pdf#page=166)
    # Source: [JCVM 3.1, s7.5.31 iastore](../3.1/JCVMSpec_3.1.pdf#page=184)
    # Source: [JCVM 3.2, s7.5.31 iastore](../3.2/JCVMSpec_3.2.pdf#page=184)
