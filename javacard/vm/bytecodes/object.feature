...
Feature: JCVM Object Operation Bytecodes
  ...
  Scenario: new -- create new object
    # Source: [JCVM 3.0.5, s7.5.70 new](../3.0.5/JCVMSpec_3.0.5.pdf#page=196)
    # Source: [JCVM 3.1, s7.5.70 new](../3.1/JCVMSpec_3.1.pdf#page=216)
    # Source: [JCVM 3.2, s7.5.70 new](../3.2/JCVMSpec_3.2.pdf#page=216)
  ...
  Scenario: checkcast -- check whether object is of given type
    # Source: [JCVM 3.0.5, s7.5.16 checkcast](../3.0.5/JCVMSpec_3.0.5.pdf#page=153)
    # Source: [JCVM 3.1, s7.5.16 checkcast](../3.1/JCVMSpec_3.1.pdf#page=171)
    # Source: [JCVM 3.2, s7.5.16 checkcast](../3.2/JCVMSpec_3.2.pdf#page=171)
  ...
  Scenario: instanceof -- determine if object is of given type
    # Source: [JCVM 3.0.5, s7.5.53 instanceof](../3.0.5/JCVMSpec_3.0.5.pdf#page=181)
    # Source: [JCVM 3.1, s7.5.53 instanceof](../3.1/JCVMSpec_3.1.pdf#page=200)
    # Source: [JCVM 3.2, s7.5.53 instanceof](../3.2/JCVMSpec_3.2.pdf#page=200)
  ...
  Scenario: getfield_a, getfield_b, getfield_s, getfield_i -- fetch field from object
    # Source: [JCVM 3.0.5, s7.5.20 getfield_<t>](../3.0.5/JCVMSpec_3.0.5.pdf#page=157)
    # Source: [JCVM 3.1, s7.5.20 getfield_<t>](../3.1/JCVMSpec_3.1.pdf#page=175)
    # Source: [JCVM 3.2, s7.5.20 getfield_<t>](../3.2/JCVMSpec_3.2.pdf#page=175)
  ...
  Scenario: getfield_a_this through getfield_i_this -- fetch field from current object
    # Source: [JCVM 3.0.5, s7.5.21 getfield_<t>_this](../3.0.5/JCVMSpec_3.0.5.pdf#page=158)
    # Source: [JCVM 3.1, s7.5.21 getfield_<t>_this](../3.1/JCVMSpec_3.1.pdf#page=176)
    # Source: [JCVM 3.2, s7.5.21 getfield_<t>_this](../3.2/JCVMSpec_3.2.pdf#page=176)
  ...
  Scenario: getfield_a_w through getfield_i_w -- fetch field from object (wide index)
    # Source: [JCVM 3.0.5, s7.5.22 getfield_<t>_w](../3.0.5/JCVMSpec_3.0.5.pdf#page=159)
    # Source: [JCVM 3.1, s7.5.22 getfield_<t>_w](../3.1/JCVMSpec_3.1.pdf#page=178)
    # Source: [JCVM 3.2, s7.5.22 getfield_<t>_w](../3.2/JCVMSpec_3.2.pdf#page=178)
  ...
  Scenario: putfield_a, putfield_b, putfield_s, putfield_i -- set field in object
    # Source: [JCVM 3.0.5, s7.5.75 putfield_<t>](../3.0.5/JCVMSpec_3.0.5.pdf#page=199)
    # Source: [JCVM 3.1, s7.5.75 putfield_<t>](../3.1/JCVMSpec_3.1.pdf#page=219)
    # Source: [JCVM 3.2, s7.5.75 putfield_<t>](../3.2/JCVMSpec_3.2.pdf#page=219)
  ...
  Scenario: putfield_a_this through putfield_i_this -- set field in current object
    # Source: [JCVM 3.0.5, s7.5.76 putfield_<t>_this](../3.0.5/JCVMSpec_3.0.5.pdf#page=200)
    # Source: [JCVM 3.1, s7.5.76 putfield_<t>_this](../3.1/JCVMSpec_3.1.pdf#page=220)
    # Source: [JCVM 3.2, s7.5.76 putfield_<t>_this](../3.2/JCVMSpec_3.2.pdf#page=220)
  ...
  Scenario: putfield_a_w through putfield_i_w -- set field in object (wide index)
    # Source: [JCVM 3.0.5, s7.5.77 putfield_<t>_w](../3.0.5/JCVMSpec_3.0.5.pdf#page=202)
    # Source: [JCVM 3.1, s7.5.77 putfield_<t>_w](../3.1/JCVMSpec_3.1.pdf#page=222)
    # Source: [JCVM 3.2, s7.5.77 putfield_<t>_w](../3.2/JCVMSpec_3.2.pdf#page=222)
  ...
  Scenario: getstatic_a, getstatic_b, getstatic_s, getstatic_i -- get static field from class
    # Source: [JCVM 3.0.5, s7.5.23 getstatic_<t>](../3.0.5/JCVMSpec_3.0.5.pdf#page=161)
    # Source: [JCVM 3.1, s7.5.23 getstatic_<t>](../3.1/JCVMSpec_3.1.pdf#page=179)
    # Source: [JCVM 3.2, s7.5.23 getstatic_<t>](../3.2/JCVMSpec_3.2.pdf#page=179)
  ...
  Scenario: putstatic_a, putstatic_b, putstatic_s, putstatic_i -- set static field in class
    # Source: [JCVM 3.0.5, s7.5.78 putstatic_<t>](../3.0.5/JCVMSpec_3.0.5.pdf#page=203)
    # Source: [JCVM 3.1, s7.5.78 putstatic_<t>](../3.1/JCVMSpec_3.1.pdf#page=223)
    # Source: [JCVM 3.2, s7.5.78 putstatic_<t>](../3.2/JCVMSpec_3.2.pdf#page=223)
  ...
  Scenario: invokevirtual -- invoke instance method, dispatch based on class
    # Source: [JCVM 3.0.5, s7.5.57 invokevirtual](../3.0.5/JCVMSpec_3.0.5.pdf#page=187)
    # Source: [JCVM 3.1, s7.5.57 invokevirtual](../3.1/JCVMSpec_3.1.pdf#page=206)
    # Source: [JCVM 3.2, s7.5.57 invokevirtual](../3.2/JCVMSpec_3.2.pdf#page=206)
  ...
  Scenario: invokeinterface -- invoke interface method
    # Source: [JCVM 3.0.5, s7.5.54 invokeinterface](../3.0.5/JCVMSpec_3.0.5.pdf#page=183)
    # Source: [JCVM 3.1, s7.5.54 invokeinterface](../3.1/JCVMSpec_3.1.pdf#page=202)
    # Source: [JCVM 3.2, s7.5.54 invokeinterface](../3.2/JCVMSpec_3.2.pdf#page=202)
  ...
  Scenario: invokespecial -- invoke instance method (special handling)
    # Source: [JCVM 3.0.5, s7.5.55 invokespecial](../3.0.5/JCVMSpec_3.0.5.pdf#page=185)
    # Source: [JCVM 3.1, s7.5.55 invokespecial](../3.1/JCVMSpec_3.1.pdf#page=204)
    # Source: [JCVM 3.2, s7.5.55 invokespecial](../3.2/JCVMSpec_3.2.pdf#page=204)
  ...
  Scenario: invokestatic -- invoke a class (static) method
    # Source: [JCVM 3.0.5, s7.5.56 invokestatic](../3.0.5/JCVMSpec_3.0.5.pdf#page=186)
    # Source: [JCVM 3.1, s7.5.56 invokestatic](../3.1/JCVMSpec_3.1.pdf#page=205)
    # Source: [JCVM 3.2, s7.5.56 invokestatic](../3.2/JCVMSpec_3.2.pdf#page=205)
