@javacardx @javacardx.framework.string @v3.0.5 @v3.1 @v3.2
Feature: StringUtil and StringException -- String Processing Utilities
  ...
  # Source: [JavaCard 3.2 API, StringUtil](../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/string/StringUtil.html)
  ...
  Scenario Outline: StringUtil defines encoding constants
    ...
    # Source: [JavaCard 3.2 API, <constant>](../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/string/StringUtil.html)
    Examples:
      | constant         | encoding                              |
      | UTF_8            | UTF-8                                 |
  ...
  Scenario: StringUtil.codePointCount counts Unicode code points
    ...
    # Source: [JavaCard 3.2 API, codePointCount](../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/string/StringUtil.html#codePointCount(byte%5B%5D,short,short,byte))
  ...
  Scenario: StringUtil.codePointAt returns the code point at an index
    ...
    # Source: [JavaCard 3.2 API, codePointAt](../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/string/StringUtil.html#codePointAt(byte%5B%5D,short,short,byte,short))
  ...
  Scenario: StringUtil.codePointBefore returns the code point before an index
    ...
    # Source: [JavaCard 3.2 API, codePointBefore](../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/string/StringUtil.html#codePointBefore(byte%5B%5D,short,short,byte,short))
  ...
  Scenario: StringUtil.offsetByCodePoints returns byte offset for code point offset
    ...
    # Source: [JavaCard 3.2 API, offsetByCodePoints](../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/string/StringUtil.html#offsetByCodePoints(byte%5B%5D,short,short,byte,short,short))
  ...
  Scenario: StringUtil.compare compares two encoded strings
    ...
    # Source: [JavaCard 3.2 API, compare](../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/string/StringUtil.html#compare)
  ...
  Scenario: StringUtil.indexOf finds substring position
    ...
    # Source: [JavaCard 3.2 API, indexOf](../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/string/StringUtil.html#indexOf)
  ...
  Scenario: StringUtil.startsWith checks string prefix
    ...
    # Source: [JavaCard 3.2 API, startsWith](../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/string/StringUtil.html#startsWith)
  ...
  Scenario: StringUtil.endsWith checks string suffix
    ...
    # Source: [JavaCard 3.2 API, endsWith](../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/string/StringUtil.html#endsWith)
  ...
  Scenario: StringUtil.replace replaces occurrences of a pattern
    ...
    # Source: [JavaCard 3.2 API, replace](../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/string/StringUtil.html#replace)
  ...
  Scenario: StringUtil.toLowerCase converts to lower case
    ...
    # Source: [JavaCard 3.2 API, toLowerCase](../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/string/StringUtil.html#toLowerCase)
  ...
  Scenario: StringUtil.toUpperCase converts to upper case
    ...
    # Source: [JavaCard 3.2 API, toUpperCase](../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/string/StringUtil.html#toUpperCase)
  ...
  Scenario: StringUtil.trim removes leading and trailing whitespace
    ...
    # Source: [JavaCard 3.2 API, trim](../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/string/StringUtil.html#trim)
  ...
  Scenario: StringUtil.substring extracts a substring
    ...
    # Source: [JavaCard 3.2 API, substring](../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/string/StringUtil.html#substring)
  ...
  Scenario: StringUtil.valueOf converts a boolean to string
    ...
    # Source: [JavaCard 3.2 API, valueOf](../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/string/StringUtil.html#valueOf(boolean,byte%5B%5D,short,byte))
  ...
  Scenario: StringUtil.parseBoolean parses a boolean from string
    ...
    # Source: [JavaCard 3.2 API, parseBoolean](../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/string/StringUtil.html#parseBoolean)
  ...
  Scenario: StringUtil.valueOf converts a short to string
    ...
    # Source: [JavaCard 3.2 API, valueOf](../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/string/StringUtil.html#valueOf(short,byte%5B%5D,short,byte))
  ...
  Scenario: StringUtil.parseShortInteger parses a short from string
    ...
    # Source: [JavaCard 3.2 API, parseShortInteger](../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/string/StringUtil.html#parseShortInteger)
  ...
  Scenario: StringUtil.convertTo converts encoding
    ...
    # Source: [JavaCard 3.2 API, convertTo](../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/string/StringUtil.html#convertTo)
  ...
  Scenario: StringUtil.convertFrom converts from platform encoding
    ...
    Then the string is transcoded from srcEncoding to destEncoding
    # Source: [JavaCard 3.2 API, convertFrom](../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/string/StringUtil.html#convertFrom)
  ...
  Scenario: StringUtil.check validates encoded string data
    ...
    # Source: [JavaCard 3.2 API, check](../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/string/StringUtil.html#check)
  ...
  Scenario Outline: StringException defines reason codes
    ...
    # Source: [JavaCard 3.2 API, <constant>](../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/string/StringException.html)
    Examples:
      | constant                |
  ...
  Scenario: StringException.throwIt throws a StringException
    ...
    # Source: [JavaCard 3.2 API, throwIt](../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/string/StringException.html#throwIt(short))
