@javacardx @javacardx.framework.nio @v3.1 @v3.2
Feature: NIO Buffer Framework -- Buffer, ByteBuffer, ByteOrder, and Exceptions
  ...
  # Source: [JavaCard 3.2 API, nio package](../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/nio package)
  ...
  Scenario: ByteOrder defines byte order constants
    ...
    # Source: [JavaCard 3.2 API, ByteOrder](../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/nio/ByteOrder.html)
  ...
  Scenario: Buffer provides position, limit, and capacity management
    ...
    # Source: [JavaCard 3.2 API, Buffer](../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/nio/Buffer.html)
  ...
  Scenario: Buffer.clear resets position to 0 and limit to capacity
    ...
    # Source: [JavaCard 3.2 API, clear](../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/nio/Buffer.html#clear)
  ...
  Scenario: Buffer.flip sets limit to current position and resets position to 0
    ...
    # Source: [JavaCard 3.2 API, flip](../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/nio/Buffer.html#flip)
  ...
  Scenario: Buffer.rewind sets position to 0 without changing limit
    ...
    # Source: [JavaCard 3.2 API, rewind](../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/nio/Buffer.html#rewind)
  ...
  Scenario: Buffer.remaining returns limit minus position
    ...
    # Source: [JavaCard 3.2 API, remaining](../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/nio/Buffer.html#remaining)

  Scenario: Buffer.hasRemaining checks if elements remain
    Given a Buffer instance
    When hasRemaining() is called
    Then returns true if position < limit
    # Source: [JavaCard 3.2 API, hasRemaining](../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/nio/Buffer.html#hasRemaining)
  ...
  Scenario: Buffer.slice creates a shared sub-buffer
    ...
    # Source: [JavaCard 3.2 API, slice](../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/nio/Buffer.html#slice)
  ...
  Scenario: ByteBuffer.allocateDirect creates a direct byte buffer
    ...
    # Source: [JavaCard 3.2 API, allocateDirect](../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/nio/ByteBuffer.html#allocateDirect(short))
  ...
  Scenario: ByteBuffer.wrap creates a buffer wrapping a byte array
    ...
    # Source: [JavaCard 3.2 API, wrap](../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/nio/ByteBuffer.html#wrap(byte%5B%5D))
  ...
  Scenario: ByteBuffer.wrap creates a buffer wrapping a byte array region
    ...
    # Source: [JavaCard 3.2 API, wrap](../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/nio/ByteBuffer.html#wrap(byte%5B%5D,short,short))
  ...
  Scenario: ByteBuffer.order retrieves the current byte order
    ...
    # Source: [JavaCard 3.2 API, order](../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/nio/ByteBuffer.html#order)
  ...
  Scenario: ByteBuffer.order sets the byte order
    ...
    # Source: [JavaCard 3.2 API, order](../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/nio/ByteBuffer.html#order(ByteOrder))
  ...
  Scenario: ByteBuffer relative get reads one byte and advances position
    ...
    # Source: [JavaCard 3.2 API, get](../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/nio/ByteBuffer.html#get)
  ...
  Scenario: ByteBuffer absolute get reads at a specific index
    ...
    # Source: [JavaCard 3.2 API, get](../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/nio/ByteBuffer.html#get(short))
  ...
  Scenario: ByteBuffer relative put writes one byte and advances position
    ...
    # Source: [JavaCard 3.2 API, put](../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/nio/ByteBuffer.html#put(byte))
  ...
  Scenario: ByteBuffer bulk get reads bytes into an array
    ...
    # Source: [JavaCard 3.2 API, get](../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/nio/ByteBuffer.html#get(byte%5B%5D,short,short))
  ...
  Scenario: ByteBuffer bulk put writes bytes from an array
    ...
    # Source: [JavaCard 3.2 API, put](../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/nio/ByteBuffer.html#put(byte%5B%5D,short,short))
  ...
  Scenario: ByteBuffer put from another ByteBuffer
    ...
    # Source: [JavaCard 3.2 API, put](../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/nio/ByteBuffer.html#put(ByteBuffer))
  ...
  Scenario: ByteBuffer.getShort reads a short value
    ...
    # Source: [JavaCard 3.2 API, getShort](../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/nio/ByteBuffer.html#getShort)
  ...
  Scenario: ByteBuffer.putShort writes a short value
    ...
    # Source: [JavaCard 3.2 API, putShort](../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/nio/ByteBuffer.html#putShort(short))
  ...
  Scenario: ByteBuffer.getInt reads an int value
    ...
    # Source: [JavaCard 3.2 API, getInt](../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/nio/ByteBuffer.html#getInt)
  ...
  Scenario: ByteBuffer.putInt writes an int value
    ...
    # Source: [JavaCard 3.2 API, putInt](../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/nio/ByteBuffer.html#putInt(int))
  ...
  Scenario: ByteBuffer.asReadOnlyBuffer creates a read-only view
    ...
    # Source: [JavaCard 3.2 API, asReadOnlyBuffer](../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/nio/ByteBuffer.html#asReadOnlyBuffer)
  ...
  Scenario: ByteBuffer.compact compacts the buffer
    ...
    # Source: [JavaCard 3.2 API, compact](../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/nio/ByteBuffer.html#compact)
  ...
  Scenario: ByteBuffer.compareTo compares two byte buffers
    ...
    # Source: [JavaCard 3.2 API, compareTo](../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/nio/ByteBuffer.html#compareTo(ByteBuffer))
  ...
  Scenario: BufferOverflowException is thrown on write past limit
    ...
    # Source: [JavaCard 3.2 API, BufferOverflowException](../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/nio/BufferOverflowException.html)
  ...
  Scenario: BufferUnderflowException is thrown on read past limit
    ...
    # Source: [JavaCard 3.2 API, BufferUnderflowException](../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/nio/BufferUnderflowException.html)
  ...
  Scenario: ReadOnlyBufferException is thrown on write to read-only buffer
    ...
    # Source: [JavaCard 3.2 API, ReadOnlyBufferException](../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/nio/ReadOnlyBufferException.html)
