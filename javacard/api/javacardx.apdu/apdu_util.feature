@javacardx @javacardx.apdu @v3.0.5 @v3.1 @v3.2
Feature: APDUUtil -- APDU CLA Byte Analysis Utility
  ...
  # Source: [JavaCard 3.2 API, APDUUtil](../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/apdu/util/APDUUtil.html)
  ...
  Scenario: APDUUtil.getCLAChannel extracts the logical channel from CLA byte
    ...
    # Source: [JavaCard 3.2 API, getCLAChannel](../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/apdu/util/APDUUtil.html#getCLAChannel(byte%5B%5D,short))
  ...
  Scenario: APDUUtil.isSecureMessagingCLA detects secure messaging
    ...
    # Source: [JavaCard 3.2 API, isSecureMessagingCLA](../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/apdu/util/APDUUtil.html#isSecureMessagingCLA(byte%5B%5D,short))
  ...
  Scenario: APDUUtil.isCommandChainingCLA detects command chaining
    ...
    And returns false otherwise
    # Source: [JavaCard 3.2 API, isCommandChainingCLA](../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/apdu/util/APDUUtil.html#isCommandChainingCLA(byte%5B%5D,short))
  ...
  Scenario: APDUUtil.isISOInterindustryCLA detects ISO interindustry class
    ...
    # Source: [JavaCard 3.2 API, isISOInterindustryCLA](../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/apdu/util/APDUUtil.html#isISOInterindustryCLA(byte%5B%5D,short))
  ...
  Scenario: APDUUtil.isValidCLA validates the CLA byte
    ...
    # Source: [JavaCard 3.2 API, isValidCLA](../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/apdu/util/APDUUtil.html#isValidCLA(byte%5B%5D,short))
