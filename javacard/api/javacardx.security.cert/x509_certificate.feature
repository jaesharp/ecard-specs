...
Feature: X509Certificate -- X.509 Certificate Field Access
  ...
  # Source: [JavaCard 3.2 API, X509Certificate](../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/security/cert/X509Certificate.html)
  ...
  Scenario Outline: X509Certificate defines TBS field constants
    ...
    # Source: [JavaCard 3.2 API, <constant>](../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/security/cert/X509Certificate.html)
    Examples:
  ...
  Scenario: X509Certificate.getVersion returns the certificate version
    ...
    # Source: [JavaCard 3.2 API, getVersion](../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/security/cert/X509Certificate.html#getVersion)
  ...
  Scenario: X509Certificate.getField retrieves a specific TBS field
    ...
    # Source: [JavaCard 3.2 API, getField](../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/security/cert/X509Certificate.html#getField(byte,byte%5B%5D,short))
  ...
  Scenario: X509Certificate.getExtension retrieves a specific extension
    ...
    # Source: [JavaCard 3.2 API, getExtension](../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/security/cert/X509Certificate.html#getExtension(byte%5B%5D,short,short,byte%5B%5D,short))
  ...
  Scenario: X509Certificate.getExtensions iterates extensions via handler
    ...
    # Source: [JavaCard 3.2 API, getExtensions](../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/security/cert/X509Certificate.html#getExtensions(ExtensionHandler))
  ...
  Scenario: X509Certificate.FieldHandler receives field data during parsing
    ...
    # Source: [JavaCard 3.2 API, FieldHandler](../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/security/cert/X509Certificate.html)
  ...
  Scenario: X509Certificate.ExtensionHandler receives extension data during parsing
    ...
    # Source: [JavaCard 3.2 API, ExtensionHandler](../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/security/cert/X509Certificate.html)
