@javacardx @javacardx.framework.util.intx @v3.0.5 @v3.1 @v3.2
Feature: JCint -- 32-bit Integer Support Utility
  ...
  # Source: [JavaCard 3.2 API, JCint](../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/util/intx/JCint.html)
  ...
  Scenario: JCint.makeInt constructs an int from two shorts
    ...
    # Source: [JavaCard 3.2 API, JCint.makeInt](../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/util/intx/JCint.html#makeInt(short,short))
  ...
  Scenario: JCint.makeInt constructs an int from four bytes
    ...
    # Source: [JavaCard 3.2 API, JCint.makeInt](../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/util/intx/JCint.html#makeInt(byte,byte,byte,byte))
  ...
  Scenario: JCint.getInt reads an int from a byte array
    ...
    # Source: [JavaCard 3.2 API, JCint.getInt](../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/util/intx/JCint.html#getInt(byte%5B%5D,short))
  ...
  Scenario: JCint.setInt writes an int to a byte array
    ...
    # Source: [JavaCard 3.2 API, JCint.setInt](../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/util/intx/JCint.html#setInt(byte%5B%5D,short,int))
  ...
  Scenario: JCint.makeTransientIntArray creates a transient int array
    ...
    # Source: [JavaCard 3.2 API, JCint.makeTransientIntArray](../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/util/intx/JCint.html#makeTransientIntArray(short,byte))
  ...
  Scenario: JCint.makeIntArrayView creates an int view over a byte array
    ...
    # Source: [JavaCard 3.2 API, JCint.makeIntArrayView](../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/util/intx/JCint.html#makeIntArrayView(byte%5B%5D,short,short))
