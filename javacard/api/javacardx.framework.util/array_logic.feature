...
Feature: ArrayLogic -- Generic Array Operations Utility
  ...
  # Source: [JavaCard 3.2 API, ArrayLogic](../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/util/ArrayLogic.html)
  ...
  Scenario: ArrayLogic.arrayCopyRepack copies with atomic transaction semantics
    ...
    # Source: [JavaCard 3.2 API, ArrayLogic.arrayCopyRepack](../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/util/ArrayLogic.html#arrayCopyRepack(Object,short,Object,short,short))
  ...
  Scenario: ArrayLogic.arrayCopyRepackNonAtomic copies without transaction semantics
    ...
    And UtilException with TYPE_MISMATCHED is thrown if types are incompatible
    # Source: [JavaCard 3.2 API, ArrayLogic.arrayCopyRepackNonAtomic](../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/util/ArrayLogic.html#arrayCopyRepackNonAtomic(Object,short,Object,short,short))
  ...
  Scenario: ArrayLogic.arrayFillGeneric fills array with a value atomically
    ...
    # Source: [JavaCard 3.2 API, ArrayLogic.arrayFillGeneric](../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/util/ArrayLogic.html#arrayFillGeneric(Object,short,short,Object,short))
  ...
  Scenario: ArrayLogic.arrayFillGenericNonAtomic fills without transaction
    ...
    # Source: [JavaCard 3.2 API, ArrayLogic.arrayFillGenericNonAtomic](../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/util/ArrayLogic.html#arrayFillGenericNonAtomic(Object,short,short,Object,short))
  ...
  Scenario: ArrayLogic.arrayCompareGeneric compares two arrays element by element
    ...
    # Source: [JavaCard 3.2 API, ArrayLogic.arrayCompareGeneric](../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/util/ArrayLogic.html#arrayCompareGeneric(Object,short,Object,short,short))
  ...
  Scenario: ArrayLogic.arrayFindGeneric finds an element in an array
    ...
    # Source: [JavaCard 3.2 API, ArrayLogic.arrayFindGeneric](../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/util/ArrayLogic.html#arrayFindGeneric(Object,short,Object,short))
