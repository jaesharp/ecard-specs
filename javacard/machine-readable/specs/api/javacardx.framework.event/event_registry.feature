@javacardx @javacardx.framework.event @v3.1 @v3.2
Feature: Event Framework -- EventListener, EventRegistry, EventSource
  ...
  # Source: [JavaCard 3.2 API, event package](../../../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/event package)
  ...
  Scenario: EventListener is a tagging interface
    ...
    # Source: [JavaCard 3.2 API, EventListener](../../../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/event/EventListener.html)
  ...
  Scenario: EventSource is a tagging interface
    ...
    # Source: [JavaCard 3.2 API, EventSource](../../../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/event/EventSource.html)
  ...
  Scenario: EventRegistry.getEventRegistry returns the singleton registry
    ...
    # Source: [JavaCard 3.2 API, getEventRegistry](../../../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/event/EventRegistry.html#getEventRegistry)
  ...
  Scenario: EventRegistry.register registers a listener for a source
    ...
    # Source: [JavaCard 3.2 API, register](../../../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/event/EventRegistry.html#register(EventSource,EventListener))
  ...
  Scenario: EventRegistry.unregister removes a listener registration
    ...
    # Source: [JavaCard 3.2 API, unregister](../../../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/event/EventRegistry.html#unregister(EventSource,EventListener))
