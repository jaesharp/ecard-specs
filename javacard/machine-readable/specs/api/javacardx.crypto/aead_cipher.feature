@javacardx @javacardx.crypto @v3.0.5 @v3.1 @v3.2
Feature: AEADCipher -- Authenticated Encryption with Associated Data
  ...
  # Source: [JavaCard 3.2 API, AEADCipher](../../../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/crypto/AEADCipher.html)
  ...
  Scenario Outline: AEADCipher defines algorithm constants
    ...
    # Source: [JavaCard 3.2 API, <constant>](../../../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/crypto/AEADCipher.html)
    Examples:
  ...
  Scenario: AEADCipher.init with key and mode uses default nonce
    ...
    # Source: [JavaCard 3.2 API, init](../../../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/crypto/AEADCipher.html#init(Key,byte))
  ...
  Scenario: AEADCipher.init with key, mode, and IV
    ...
    # Source: [JavaCard 3.2 API, init](../../../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/crypto/AEADCipher.html#init(Key,byte,byte%5B%5D,short,short))
  ...
  Scenario: AEADCipher.init with full parameters for offline mode (CCM)
    ...
    # Source: [JavaCard 3.2 API, init](../../../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/crypto/AEADCipher.html#init(Key,byte,byte%5B%5D,short,short,short,short,short))
  ...
  Scenario: AEADCipher.updateAAD provides associated data
    ...
    # Source: [JavaCard 3.2 API, updateAAD](../../../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/crypto/AEADCipher.html#updateAAD(byte%5B%5D,short,short))
  ...
  Scenario: AEADCipher.update processes message data
    ...
    # Source: [JavaCard 3.2 API, update](../../../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/crypto/AEADCipher.html#update(byte%5B%5D,short,short,byte%5B%5D,short))
  ...
  Scenario: AEADCipher.doFinal completes encryption/decryption and resets state
    ...
    # Source: [JavaCard 3.2 API, doFinal](../../../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/crypto/AEADCipher.html#doFinal(byte%5B%5D,short,short,byte%5B%5D,short))
  ...
  Scenario: AEADCipher.retrieveTag retrieves authentication tag after encryption
    ...
    # Source: [JavaCard 3.2 API, retrieveTag](../../../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/crypto/AEADCipher.html#retrieveTag(byte%5B%5D,short,short))
  ...
  Scenario: AEADCipher.verifyTag verifies authentication tag after decryption
    ...
    # Source: [JavaCard 3.2 API, verifyTag](../../../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/crypto/AEADCipher.html#verifyTag(byte%5B%5D,short,short,short))
