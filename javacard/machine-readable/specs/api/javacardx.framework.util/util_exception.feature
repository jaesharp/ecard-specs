...
Feature: UtilException -- Utility Package Exception
  ...
  Scenario: UtilException defines reason code ILLEGAL_VALUE
    ...
    # Source: [JavaCard 3.2 API, ILLEGAL_VALUE](../../refs/javadoc-3.2/api_classic/javacardx/framework/util/UtilException/ILLEGAL_VALUE.html)
  ...
  Scenario: UtilException defines reason code TYPE_MISMATCHED
    ...
    # Source: [JavaCard 3.2 API, TYPE_MISMATCHED](../../refs/javadoc-3.2/api_classic/javacardx/framework/util/UtilException/TYPE_MISMATCHED.html)
