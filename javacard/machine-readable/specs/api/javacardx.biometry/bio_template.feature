@javacardx @javacardx.biometry @v3.0.5 @v3.1 @v3.2
Feature: Biometry 1:1 -- BioTemplate, OwnerBioTemplate, SharedBioTemplate, BioBuilder, BioException
  ...
  # Source: [JavaCard 3.2 API, biometry package](../../../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/biometry package)
  ...
  Scenario Outline: BioBuilder defines biometric type constants
    ...
    # Source: [JavaCard 3.2 API, BioBuilder](../../../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/biometry/BioBuilder.html)
    Examples:
      | constant           |
      | FACIAL_FEATURE     |
      | VOICE_PRINT        |
  ...
  Scenario: BioBuilder.buildBioTemplate creates an OwnerBioTemplate
    ...
    # Source: [JavaCard 3.2 API, buildBioTemplate](../../../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/biometry/BioBuilder.html#buildBioTemplate(byte,byte))
  ...
  Scenario: BioBuilder.buildBioTemplate with RID creates an OwnerBioTemplate for a specific provider
    ...
    # Source: [JavaCard 3.2 API, buildBioTemplate](../../../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/biometry/BioBuilder.html#buildBioTemplate(byte%5B%5D,short,byte,byte,byte))
  ...
  Scenario: BioTemplate.isInitialized checks if reference data is loaded
    ...
    # Source: [JavaCard 3.2 API, isInitialized](../../../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/biometry/BioTemplate.html#isInitialized)
  ...
  Scenario: BioTemplate.isValidated checks if match was successful
    ...
    # Source: [JavaCard 3.2 API, isValidated](../../../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/biometry/BioTemplate.html#isValidated)
  ...
  Scenario: BioTemplate.reset resets the validated state
    ...
    # Source: [JavaCard 3.2 API, reset](../../../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/biometry/BioTemplate.html#reset)
  ...
  Scenario: BioTemplate.getTriesRemaining returns remaining match attempts
    ...
    # Source: [JavaCard 3.2 API, getTriesRemaining](../../../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/biometry/BioTemplate.html#getTriesRemaining)
  ...
  Scenario: BioTemplate.getBioType returns the biometric type
    ...
    # Source: [JavaCard 3.2 API, getBioType](../../../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/biometry/BioTemplate.html#getBioType)
  ...
  Scenario: BioTemplate.getVersion returns the version information
    ...
    # Source: [JavaCard 3.2 API, getVersion](../../../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/biometry/BioTemplate.html#getVersion(byte%5B%5D,short))
  ...
  Scenario: BioTemplate.getPublicTemplateData retrieves public data
    ...
    # Source: [JavaCard 3.2 API, getPublicTemplateData](../../../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/biometry/BioTemplate.html#getPublicTemplateData(short,byte%5B%5D,short,short))
  ...
  Scenario: BioTemplate.initMatch begins a biometric match
    ...
    # Source: [JavaCard 3.2 API, initMatch](../../../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/biometry/BioTemplate.html#initMatch(byte%5B%5D,short,short))
  ...
  Scenario: BioTemplate.match continues or completes biometric matching
    ...
    # Source: [JavaCard 3.2 API, match](../../../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/biometry/BioTemplate.html#match(byte%5B%5D,short,short))
  ...
  Scenario: BioTemplate defines match score constants
    ...
    # Source: [JavaCard 3.2 API, BioTemplate](../../../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/biometry/BioTemplate.html)
  ...
  Scenario: OwnerBioTemplate.init begins enrollment of reference data
    ...
    # Source: [JavaCard 3.2 API, init](../../../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/biometry/OwnerBioTemplate.html#init(byte%5B%5D,short,short))
  ...
  Scenario: OwnerBioTemplate.update continues enrollment
    ...
    # Source: [JavaCard 3.2 API, update](../../../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/biometry/OwnerBioTemplate.html#update(byte%5B%5D,short,short))
  ...
  Scenario: OwnerBioTemplate.doFinal completes enrollment
    ...
    # Source: [JavaCard 3.2 API, doFinal](../../../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/biometry/OwnerBioTemplate.html#doFinal(byte%5B%5D,short,short))
  ...
  Scenario: OwnerBioTemplate.resetUnblockAndSetTryLimit resets the template
    ...
    # Source: [JavaCard 3.2 API, resetUnblockAndSetTryLimit](../../../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/biometry/OwnerBioTemplate.html#resetUnblockAndSetTryLimit(byte))
  ...
  Scenario: OwnerBioTemplate.clear erases reference data
    ...
    # Source: [JavaCard 3.2 API, clear](../../../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/biometry/OwnerBioTemplate.html#clear)
  ...
  Scenario: SharedBioTemplate extends BioTemplate and Shareable
    ...
    # Source: [JavaCard 3.2 API, SharedBioTemplate](../../../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/biometry/SharedBioTemplate.html)
  ...
  Scenario Outline: BioException defines reason codes
    ...
    # Source: [JavaCard 3.2 API, <constant>](../../../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/biometry/BioException.html)
    Examples:
  ...
  Scenario: BioException.throwIt throws a BioException
    ...
    # Source: [JavaCard 3.2 API, throwIt](../../../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/biometry/BioException.html#throwIt(short))
