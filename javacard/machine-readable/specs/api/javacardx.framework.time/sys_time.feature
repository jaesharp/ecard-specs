@javacardx @javacardx.framework.time @v3.1 @v3.2
Feature: Time Framework -- SysTime, TimeDuration, DateTimeException
  ...
  # Source: [JavaCard 3.2 API, time package](../../../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/time package)
  ...
  Scenario: SysTime.uptime returns system uptime as a TimeDuration
    ...
    # Source: [JavaCard 3.2 API, uptime](../../../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/time/SysTime.html#uptime(TimeDuration))
  ...
  Scenario Outline: TimeDuration defines time unit constants
    ...
    # Source: [JavaCard 3.2 API, TimeDuration](../../../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/time/TimeDuration.html)
    Examples:
      | constant | unit         |
      | MICROS   | microseconds |
      | MILLIS   | milliseconds |
  ...
  Scenario: TimeDuration.getInstance creates a persistent TimeDuration
    ...
    # Source: [JavaCard 3.2 API, getInstance](../../../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/time/TimeDuration.html#getInstance(byte))
  ...
  Scenario: TimeDuration.getInstance creates a transient TimeDuration
    ...
    # Source: [JavaCard 3.2 API, getInstance](../../../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/time/TimeDuration.html#getInstance(byte,byte))
  ...
  Scenario: TimeDuration.getMemoryType returns the memory type
    ...
    # Source: [JavaCard 3.2 API, getMemoryType](../../../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/time/TimeDuration.html#getMemoryType)
  ...
  Scenario: TimeDuration.plus adds another TimeDuration
    ...
    # Source: [JavaCard 3.2 API, plus](../../../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/time/TimeDuration.html#plus(TimeDuration))
  ...
  Scenario: TimeDuration.plus adds a scalar amount
    ...
    # Source: [JavaCard 3.2 API, plus](../../../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/time/TimeDuration.html#plus(short,byte))
  ...
  Scenario: TimeDuration.minus subtracts another TimeDuration
    ...
    # Source: [JavaCard 3.2 API, minus](../../../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/time/TimeDuration.html#minus(TimeDuration))
  ...
  Scenario: TimeDuration.minus subtracts a scalar amount
    ...
    # Source: [JavaCard 3.2 API, minus](../../../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/time/TimeDuration.html#minus(short,byte))

  Scenario: TimeDuration.neg negates the duration
    Given a TimeDuration instance
    When neg() is called
    Then the sign of the duration is reversed
    # Source: [JavaCard 3.2 API, neg](../../../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/time/TimeDuration.html#neg)

  Scenario: TimeDuration.abs returns absolute value
    Given a negative TimeDuration instance
    When abs() is called
    Then the duration becomes positive
    # Source: [JavaCard 3.2 API, abs](../../../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/time/TimeDuration.html#abs)
  ...
  Scenario: TimeDuration.isNegative checks sign
    ...
    # Source: [JavaCard 3.2 API, isNegative](../../../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/time/TimeDuration.html#isNegative)
  ...
  Scenario: TimeDuration.compareTo compares with another TimeDuration
    ...
    # Source: [JavaCard 3.2 API, compareTo](../../../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/time/TimeDuration.html#compareTo(TimeDuration))
  ...
  Scenario: TimeDuration.set sets the duration value
    ...
    # Source: [JavaCard 3.2 API, set](../../../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/time/TimeDuration.html#set(short,byte))

  Scenario: TimeDuration.reset clears the duration to zero
    Given a TimeDuration instance
    When reset() is called
    Then the duration is set to zero
    # Source: [JavaCard 3.2 API, reset](../../../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/time/TimeDuration.html#reset)
  ...
  Scenario: TimeDuration.toBytes serializes the duration
    ...
    # Source: [JavaCard 3.2 API, toBytes](../../../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/time/TimeDuration.html#toBytes(byte%5B%5D,short))
  ...
  Scenario: TimeDuration.getByteLength returns serialized length
    ...
    # Source: [JavaCard 3.2 API, getByteLength](../../../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/time/TimeDuration.html#getByteLength)
  ...
  Scenario: DateTimeException defines reason codes
    ...
    # Source: [JavaCard 3.2 API, DateTimeException](../../../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/time/DateTimeException.html)
  ...
  Scenario: DateTimeException.throwIt throws a DateTimeException
    ...
    # Source: [JavaCard 3.2 API, throwIt](../../../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/time/DateTimeException.html#throwIt(short))
