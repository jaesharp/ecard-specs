...
Feature: External Memory Access -- Memory, MemoryAccess, ExternalException
  ...
  # Source: [JavaCard 3.2 API, external package](../../../refs/javadoc-3.2/api_classic/javacardx/external/package-summary.html)
  Background:
  ...
  # Source: [JavaCard 3.2 API, Memory](../../../refs/javadoc-3.2/api_classic/javacardx/external/Memory.html)
  ...
  # Source: [JavaCard 3.2 API, getMemoryAccessInstance](../../../refs/javadoc-3.2/api_classic/javacardx/external/Memory.html#getMemoryAccessInstance(byte,short%5B%5D,short))
  ...
  # Source: [JavaCard 3.2 API, readData](../../../refs/javadoc-3.2/api_classic/javacardx/external/MemoryAccess.html#readData(byte%5B%5D,short,short%5B%5D,short,short,short,short))
  ...
  # Source: [JavaCard 3.2 API, writeData](../../../refs/javadoc-3.2/api_classic/javacardx/external/MemoryAccess.html#writeData(byte%5B%5D,short,short,short%5B%5D,short,short,short))
  # ========== ExternalException ==========
  Scenario Outline: ExternalException defines reason codes
    ...
    # Source: [JavaCard 3.2 API, <constant>](../../../refs/javadoc-3.2/api_classic/javacardx/external/ExternalException.html)
    Examples:
