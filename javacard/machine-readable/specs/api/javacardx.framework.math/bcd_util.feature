...
Feature: BCDUtil -- Binary Coded Decimal Utility
  ...
  # Source: [JavaCard 3.2 API, BCDUtil](../../../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/math/BCDUtil.html)
  ...
  Scenario: BCDUtil.getMaxBytesSupported returns the platform maximum
    ...
    # Source: [JavaCard 3.2 API, getMaxBytesSupported](../../../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/math/BCDUtil.html#getMaxBytesSupported)
  ...
  Scenario: BCDUtil.convertToHex converts BCD to hexadecimal
    ...
    # Source: [JavaCard 3.2 API, convertToHex](../../../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/math/BCDUtil.html#convertToHex(byte%5B%5D,short,short,byte%5B%5D,short))
  ...
  Scenario: BCDUtil.convertToBCD converts hexadecimal to BCD
    ...
    # Source: [JavaCard 3.2 API, convertToBCD](../../../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/math/BCDUtil.html#convertToBCD(byte%5B%5D,short,short,byte%5B%5D,short))
  ...
  Scenario: BCDUtil.isBCDFormat validates BCD data
    ...
    # Source: [JavaCard 3.2 API, isBCDFormat](../../../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/math/BCDUtil.html#isBCDFormat(byte%5B%5D,short,short))
