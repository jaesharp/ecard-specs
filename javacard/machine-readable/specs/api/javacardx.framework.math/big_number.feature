...
Feature: BigNumber -- Arbitrary Precision Numeric Operations
  ...
  # Source: [JavaCard 3.2 API, BigNumber](../../../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/math/BigNumber.html)
  ...
  Scenario: BigNumber constructor creates a new instance with specified maximum size
    ...
    # Source: [JavaCard 3.2 API, BigNumber](../../../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/math/BigNumber.html#BigNumber(short))
  ...
  Scenario: BigNumber.setMaximum sets the maximum byte length
    ...
    # Source: [JavaCard 3.2 API, setMaximum](../../../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/math/BigNumber.html#setMaximum(short))
  ...
  Scenario: BigNumber.getMaxBytesSupported returns the platform maximum
    ...
    # Source: [JavaCard 3.2 API, getMaxBytesSupported](../../../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/math/BigNumber.html#getMaxBytesSupported)
  ...
  Scenario: BigNumber.init initializes with a byte array value
    ...
    # Source: [JavaCard 3.2 API, init](../../../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/math/BigNumber.html#init(byte%5B%5D,short,short,byte))
  ...
  Scenario: BigNumber.add performs addition
    ...
    # Source: [JavaCard 3.2 API, add](../../../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/math/BigNumber.html#add(byte%5B%5D,short,short,byte))
  ...
  Scenario: BigNumber.subtract performs subtraction
    ...
    # Source: [JavaCard 3.2 API, subtract](../../../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/math/BigNumber.html#subtract(byte%5B%5D,short,short,byte))
  ...
  Scenario: BigNumber.multiply performs multiplication
    ...
    # Source: [JavaCard 3.2 API, multiply](../../../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/math/BigNumber.html#multiply(byte%5B%5D,short,short,byte))
  ...
  Scenario: BigNumber.compareTo compares with a byte array value
    ...
    # Source: [JavaCard 3.2 API, compareTo](../../../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/math/BigNumber.html#compareTo(byte%5B%5D,short,short,byte))
  ...
  Scenario: BigNumber.compareTo compares with another BigNumber
    ...
    # Source: [JavaCard 3.2 API, compareTo](../../../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/math/BigNumber.html#compareTo(BigNumber))
  ...
  Scenario: BigNumber.toBytes exports value to byte array
    ...
    # Source: [JavaCard 3.2 API, toBytes](../../../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/math/BigNumber.html#toBytes(byte%5B%5D,short,short,byte))
  ...
  Scenario: BigNumber.getByteLength returns the current value length
    ...
    # Source: [JavaCard 3.2 API, getByteLength](../../../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/math/BigNumber.html#getByteLength(byte))

  Scenario: BigNumber.reset clears the value to zero
    Given an initialized BigNumber
    When reset() is called
    Then the BigNumber value is reset to zero
    # Source: [JavaCard 3.2 API, reset](../../../../java_card_spec-3_2_0-b_185-18_jan_2023/api_classic/javacardx/framework/math/BigNumber.html#reset)
