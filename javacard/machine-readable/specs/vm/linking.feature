...
Feature: JCVM Binary Representation, AID Naming, Token-based Linking, and Binary Compatibility
  ...
  # Source: [JCVM 3.0.5, s4 Binary Representation](../../../3.0.5/JCVMSpec_3.0.5.pdf#page=51)
  # Source: [JCVM 3.1, s4 Binary Representation](../../../3.1/JCVMSpec_3.1.pdf#page=51)
  # Source: [JCVM 3.2, s4 Binary Representation](../../../3.2/JCVMSpec_3.2.pdf#page=51)
  ...
  Scenario: Two binary file formats -- CAP file and export file
    # Source: [JCVM 3.0.5, s4.1 Java Card Platform File Formats](../../../3.0.5/JCVMSpec_3.0.5.pdf#page=51)
    # Source: [JCVM 3.2, s4.1](../../../3.2/JCVMSpec_3.2.pdf#page=51)
  ...
  Scenario: CAP file is the Java Card equivalent of a class file
    # Source: [JCVM 3.0.5, s4.1.2 CAP File Format](../../../3.0.5/JCVMSpec_3.0.5.pdf#page=52)
    # Source: [JCVM 3.2, s4.1.2](../../../3.2/JCVMSpec_3.2.pdf#page=52)
  ...
  Scenario: JAR file is the container for CAP files
    # Source: [JCVM 3.0.5, s4.1.3 JAR File Container](../../../3.0.5/JCVMSpec_3.0.5.pdf#page=52)
    # Source: [JCVM 3.2, s4.1.3](../../../3.2/JCVMSpec_3.2.pdf#page=52)
  ...
  Scenario: AID format -- RID (5 bytes) plus PIX (0-11 bytes)
    # Source: [JCVM 3.0.5, s4.2.1 The AID Format](../../../3.0.5/JCVMSpec_3.0.5.pdf#page=53)
    # Source: [JCVM 3.2, s4.2.1](../../../3.2/JCVMSpec_3.2.pdf#page=53)
  ...
  Scenario: CAP file AID namespace -- no two CAP files may share an AID
    # Source: [JCVM 3.0.5, s4.2.2.1 CAP File AID namespace](../../../3.0.5/JCVMSpec_3.0.5.pdf#page=53)
    # Source: [JCVM 3.2, s4.2.2.1](../../../3.2/JCVMSpec_3.2.pdf#page=53)
  ...
  Scenario: Applet AID namespace -- unique per applet, shared RID with CAP file
    # Source: [JCVM 3.0.5, s4.2.2.2 Applet AID namespace](../../../3.0.5/JCVMSpec_3.0.5.pdf#page=53)
    # Source: [JCVM 3.2, s4.2.2.2](../../../3.2/JCVMSpec_3.2.pdf#page=53)
  ...
  Scenario: Package AID namespace -- unique per package
    # Source: [JCVM 3.0.5, s4.2.2.3 Package AID namespace](../../../3.0.5/JCVMSpec_3.0.5.pdf#page=54)
    # Source: [JCVM 3.2, s4.2.2.3](../../../3.2/JCVMSpec_3.2.pdf#page=54)
  ...
  Scenario: Six kinds of externally visible items require tokens
    # Source: [JCVM 3.0.5, s4.3.1 Externally Visible Items](../../../3.0.5/JCVMSpec_3.0.5.pdf#page=54)
    # Source: [JCVM 3.2, s4.3.1](../../../3.2/JCVMSpec_3.2.pdf#page=54)
  ...
  Scenario: Private tokens for internal linking
    # Source: [JCVM 3.0.5, s4.3.2 Private Tokens](../../../3.0.5/JCVMSpec_3.0.5.pdf#page=54)
    # Source: [JCVM 3.2, s4.3.2](../../../3.2/JCVMSpec_3.2.pdf#page=55)
  ...
  Scenario: Export file maps names to tokens during conversion
    # Source: [JCVM 3.0.5, s4.3.3 The Export File and Conversion](../../../3.0.5/JCVMSpec_3.0.5.pdf#page=54)
    # Source: [JCVM 3.2, s4.3.3](../../../3.2/JCVMSpec_3.2.pdf#page=55)
  ...
  Scenario: External references use package token + item token; internal references use offsets
    # Source: [JCVM 3.0.5, s4.3.4 References](../../../3.0.5/JCVMSpec_3.0.5.pdf#page=55)
    # Source: [JCVM 3.2, s4.3.4](../../../3.2/JCVMSpec_3.2.pdf#page=55)
  ...
  Scenario: Instance field token assignment -- public reference fields before private, int skips a token
    # Source: [JCVM 3.0.5, s4.3.7.5 Instance Fields](../../../3.0.5/JCVMSpec_3.0.5.pdf#page=57)
    # Source: [JCVM 3.2, s4.3.7.5](../../../3.2/JCVMSpec_3.2.pdf#page=57)
  ...
  Scenario: Virtual method token high bit indicates public (0) or private (1)
    # Source: [JCVM 3.0.5, s4.3.7.6 Virtual Methods](../../../3.0.5/JCVMSpec_3.0.5.pdf#page=57)
    # Source: [JCVM 3.2, s4.3.7.6](../../../3.2/JCVMSpec_3.2.pdf#page=58)
  ...
  Scenario: Binary compatibility between package versions
    # Source: [JCVM 3.0.5, s4.4 Binary Compatibility](../../../3.0.5/JCVMSpec_3.0.5.pdf#page=58)
    # Source: [JCVM 3.2, s4.4](../../../3.2/JCVMSpec_3.2.pdf#page=59)
  ...
  Scenario: Package versioning -- major.minor version numbers
    # Source: [JCVM 3.0.5, s4.5 Package Versions](../../../3.0.5/JCVMSpec_3.0.5.pdf#page=60)
    # Source: [JCVM 3.2, s4.5](../../../3.2/JCVMSpec_3.2.pdf#page=60)
  ...
  Scenario: Version compatibility during linking
    # Source: [JCVM 3.0.5, s4.5.2 Linking](../../../3.0.5/JCVMSpec_3.0.5.pdf#page=60)
    # Source: [JCVM 3.2, s4.5.2](../../../3.2/JCVMSpec_3.2.pdf#page=60)
