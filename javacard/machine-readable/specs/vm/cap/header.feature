...
Feature: CAP File Header Component
  ...
  # Source: [JCVM 3.0.5, s6.4 Header Component](../../refs/3.0.5/JCVMSpec_3.0.5.pdf#page=79)
  # Source: [JCVM 3.1, s6.4 Header Component](../../refs/3.1/JCVMSpec_3.1.pdf#page=81)
  # Source: [JCVM 3.2, s6.4 Header Component](../../refs/3.2/JCVMSpec_3.2.pdf#page=81)
  ...
  Scenario: Header component tag is COMPONENT_Header (1)
    # Source: [JCVM 3.2, s6.4](../../refs/3.2/JCVMSpec_3.2.pdf#page=82)
    Then the tag item shall have the value 1 (COMPONENT_Header)

  @v3.0.5 @v3.1 @v3.2
  Scenario: Magic number is 0xDECAFFED
    # Source: [JCVM 3.0.5, s6.4](../../refs/3.0.5/JCVMSpec_3.0.5.pdf#page=80)
    # Source: [JCVM 3.2, s6.4](../../refs/3.2/JCVMSpec_3.2.pdf#page=82)
  ...
  Scenario: ACC_INT flag indicates use of int data type
    # Source: [JCVM 3.0.5, s6.4 Table 6-3](../../refs/3.0.5/JCVMSpec_3.0.5.pdf#page=81)
    # Source: [JCVM 3.2, s6.4 Table 6-3](../../refs/3.2/JCVMSpec_3.2.pdf#page=83)
  ...
  Scenario: ACC_EXTENDED flag indicates Extended format CAP file
    # Source: [JCVM 3.1, s6.4 Table 6-3](../../refs/3.1/JCVMSpec_3.1.pdf#page=83)
    # Source: [JCVM 3.2, s6.4 Table 6-3](../../refs/3.2/JCVMSpec_3.2.pdf#page=83)
  ...
  Scenario: package_info structure contains AID and version
    # Source: [JCVM 3.0.5, s6.4](../../refs/3.0.5/JCVMSpec_3.0.5.pdf#page=82)
    # Source: [JCVM 3.2, s6.4](../../refs/3.2/JCVMSpec_3.2.pdf#page=84)
  ...
  Scenario: Compact format header contains single package_info
    # Source: [JCVM 3.0.5, s6.4](../../refs/3.0.5/JCVMSpec_3.0.5.pdf#page=79)
    # Source: [JCVM 3.2, s6.4](../../refs/3.2/JCVMSpec_3.2.pdf#page=81)
  ...
  Scenario: Extended format header contains CAP AID, package count, and package array
    # Source: [JCVM 3.1, s6.4](../../refs/3.1/JCVMSpec_3.1.pdf#page=82)
    # Source: [JCVM 3.2, s6.4](../../refs/3.2/JCVMSpec_3.2.pdf#page=82)
