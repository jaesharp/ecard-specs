...
Feature: CAP File Constant Pool Component
  ...
  # Source: [JCVM 3.0.5, s6.8 Constant Pool Component](../../../refs/3.0.5/JCVMSpec_3.0.5.pdf#page=88)
  # Source: [JCVM 3.1, s6.8 Constant Pool Component](../../../refs/3.1/JCVMSpec_3.1.pdf#page=93)
  # Source: [JCVM 3.2, s6.8 Constant Pool Component](../../../refs/3.2/JCVMSpec_3.2.pdf#page=93)
  Background:
  ...
  Scenario: Constant pool component structure
    # Source: [JCVM 3.0.5, s6.8](../../../refs/3.0.5/JCVMSpec_3.0.5.pdf#page=88)
    # Source: [JCVM 3.2, s6.8](../../../refs/3.2/JCVMSpec_3.2.pdf#page=93)
  ...
  Scenario: cp_info is always 4 bytes -- 1 byte tag plus 3 bytes info
    # Source: [JCVM 3.0.5, s6.8](../../../refs/3.0.5/JCVMSpec_3.0.5.pdf#page=89)
    # Source: [JCVM 3.2, s6.8](../../../refs/3.2/JCVMSpec_3.2.pdf#page=94)
  ...
  Scenario: CONSTANT_Classref (tag = 1) -- reference to a class or interface
    # Source: [JCVM 3.0.5, s6.8.1 CONSTANT_Classref](../../../refs/3.0.5/JCVMSpec_3.0.5.pdf#page=90)
    # Source: [JCVM 3.1, s6.8.1](../../../refs/3.1/JCVMSpec_3.1.pdf#page=95)
    # Source: [JCVM 3.2, s6.8.1](../../../refs/3.2/JCVMSpec_3.2.pdf#page=95)
  ...
  Scenario: CONSTANT_InstanceFieldref (tag = 2) -- reference to an instance field
    # Source: [JCVM 3.0.5, s6.8.2](../../../refs/3.0.5/JCVMSpec_3.0.5.pdf#page=91)
    # Source: [JCVM 3.1, s6.8.2](../../../refs/3.1/JCVMSpec_3.1.pdf#page=96)
    # Source: [JCVM 3.2, s6.8.2](../../../refs/3.2/JCVMSpec_3.2.pdf#page=96)
  ...
  Scenario: CONSTANT_StaticFieldref (tag = 5) -- reference to a static field
    # Source: [JCVM 3.0.5, s6.8.3](../../../refs/3.0.5/JCVMSpec_3.0.5.pdf#page=93)
    # Source: [JCVM 3.1, s6.8.3](../../../refs/3.1/JCVMSpec_3.1.pdf#page=98)
    # Source: [JCVM 3.2, s6.8.3](../../../refs/3.2/JCVMSpec_3.2.pdf#page=98)
