...
Feature: CAP File Method Component
  ...
  # Source: [JCVM 3.0.5, s6.10 Method Component](../../../refs/3.0.5/JCVMSpec_3.0.5.pdf#page=108)
  # Source: [JCVM 3.1, s6.10 Method Component](../../../refs/3.1/JCVMSpec_3.1.pdf#page=116)
  # Source: [JCVM 3.2, s6.10 Method Component](../../../refs/3.2/JCVMSpec_3.2.pdf#page=116)
  Background:
  ...
  Scenario: Method component compact structure
    # Source: [JCVM 3.0.5, s6.10](../../../refs/3.0.5/JCVMSpec_3.0.5.pdf#page=108)
    # Source: [JCVM 3.2, s6.10](../../../refs/3.2/JCVMSpec_3.2.pdf#page=116)
  ...
  Scenario: Method component extended structure (since CAP format 2.3)
    # Source: [JCVM 3.1, s6.10](../../../refs/3.1/JCVMSpec_3.1.pdf#page=116)
    # Source: [JCVM 3.2, s6.10](../../../refs/3.2/JCVMSpec_3.2.pdf#page=116)
  ...
  Scenario: method_component_block structure (since CAP format 2.3)
    # Source: [JCVM 3.1, s6.10.1](../../../refs/3.1/JCVMSpec_3.1.pdf#page=117)
    # Source: [JCVM 3.2, s6.10.1](../../../refs/3.2/JCVMSpec_3.2.pdf#page=117)
  ...
  Scenario: exception_handler_info structure -- 8 bytes per handler
    # Source: [JCVM 3.0.5, s6.10.2 exception_handler_info](../../../refs/3.0.5/JCVMSpec_3.0.5.pdf#page=110)
    # Source: [JCVM 3.1, s6.10.3](../../../refs/3.1/JCVMSpec_3.1.pdf#page=119)
    # Source: [JCVM 3.2, s6.10.3](../../../refs/3.2/JCVMSpec_3.2.pdf#page=119)
  ...
  Scenario: stop_bit optimization for exception handler search
    # Source: [JCVM 3.0.5, s6.10.2](../../../refs/3.0.5/JCVMSpec_3.0.5.pdf#page=111)
    # Source: [JCVM 3.2, s6.10.3](../../../refs/3.2/JCVMSpec_3.2.pdf#page=120)
  ...
  Scenario: Exception handlers sorted by handler_offset in ascending order
    # Source: [JCVM 3.0.5, s6.10](../../../refs/3.0.5/JCVMSpec_3.0.5.pdf#page=109)
    # Source: [JCVM 3.2, s6.10](../../../refs/3.2/JCVMSpec_3.2.pdf#page=118)
  ...
  Scenario: method_info structure -- header followed by bytecodes
    # Source: [JCVM 3.0.5, s6.10.3 method_info](../../../refs/3.0.5/JCVMSpec_3.0.5.pdf#page=112)
    # Source: [JCVM 3.1, s6.10.4](../../../refs/3.1/JCVMSpec_3.1.pdf#page=121)
    # Source: [JCVM 3.2, s6.10.4](../../../refs/3.2/JCVMSpec_3.2.pdf#page=121)
  ...
  Scenario: method_header_info (compact, 2 bytes)
    # Source: [JCVM 3.0.5, s6.10.3](../../../refs/3.0.5/JCVMSpec_3.0.5.pdf#page=112)
    # Source: [JCVM 3.2, s6.10.4](../../../refs/3.2/JCVMSpec_3.2.pdf#page=121)
  ...
  Scenario: Method flags ACC_EXTENDED and ACC_ABSTRACT
    # Source: [JCVM 3.0.5, s6.10.3 Table 6-12](../../../refs/3.0.5/JCVMSpec_3.0.5.pdf#page=113)
    # Source: [JCVM 3.2, s6.10.4 Table 6-12](../../../refs/3.2/JCVMSpec_3.2.pdf#page=122)
  ...
  Scenario: max_locals does not include method parameters
    # Source: [JCVM 3.0.5, s6.10.3](../../../refs/3.0.5/JCVMSpec_3.0.5.pdf#page=113)
    # Source: [JCVM 3.2, s6.10.4](../../../refs/3.2/JCVMSpec_3.2.pdf#page=122)
