...
Feature: JCVM Return and Miscellaneous Bytecodes
  ...
  Scenario: return -- return void from method
    # Source: [JCVM 3.0.5, s7.5.80 return](../../../refs/3.0.5/JCVMSpec_3.0.5.pdf#page=205)
    # Source: [JCVM 3.1, s7.5.80 return](../../../refs/3.1/JCVMSpec_3.1.pdf#page=225)
    # Source: [JCVM 3.2, s7.5.80 return](../../../refs/3.2/JCVMSpec_3.2.pdf#page=225)
  ...
  Scenario: sreturn -- return short from method
    # Source: [JCVM 3.0.5, s7.5.99 sreturn](../../../refs/3.0.5/JCVMSpec_3.0.5.pdf#page=216)
    # Source: [JCVM 3.1, s7.5.99 sreturn](../../../refs/3.1/JCVMSpec_3.1.pdf#page=236)
    # Source: [JCVM 3.2, s7.5.99 sreturn](../../../refs/3.2/JCVMSpec_3.2.pdf#page=236)
  ...
  Scenario: ireturn -- return int from method
    # Source: [JCVM 3.0.5, s7.5.60 ireturn](../../../refs/3.0.5/JCVMSpec_3.0.5.pdf#page=189)
    # Source: [JCVM 3.1, s7.5.60 ireturn](../../../refs/3.1/JCVMSpec_3.1.pdf#page=209)
    # Source: [JCVM 3.2, s7.5.60 ireturn](../../../refs/3.2/JCVMSpec_3.2.pdf#page=209)
  ...
  Scenario: areturn -- return reference from method
    # Source: [JCVM 3.0.5, s7.5.7 areturn](../../../refs/3.0.5/JCVMSpec_3.0.5.pdf#page=147)
    # Source: [JCVM 3.1, s7.5.7 areturn](../../../refs/3.1/JCVMSpec_3.1.pdf#page=165)
    # Source: [JCVM 3.2, s7.5.7 areturn](../../../refs/3.2/JCVMSpec_3.2.pdf#page=165)
  ...
  Scenario: athrow -- throw exception or error
    # Source: [JCVM 3.0.5, s7.5.11 athrow](../../../refs/3.0.5/JCVMSpec_3.0.5.pdf#page=149)
    # Source: [JCVM 3.1, s7.5.11 athrow](../../../refs/3.1/JCVMSpec_3.1.pdf#page=168)
    # Source: [JCVM 3.2, s7.5.11 athrow](../../../refs/3.2/JCVMSpec_3.2.pdf#page=168)
  ...
  Scenario: nop -- do nothing
    # Source: [JCVM 3.0.5, s7.5.72 nop](../../../refs/3.0.5/JCVMSpec_3.0.5.pdf#page=197)
    # Source: [JCVM 3.1, s7.5.72 nop](../../../refs/3.1/JCVMSpec_3.1.pdf#page=217)
    # Source: [JCVM 3.2, s7.5.72 nop](../../../refs/3.2/JCVMSpec_3.2.pdf#page=217)
