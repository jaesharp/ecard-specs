...
Feature: JCVM Control Flow Bytecodes
  ...
  Scenario: goto -- branch always (8-bit offset)
    # Source: [JCVM 3.0.5, s7.5.24 goto](../../refs/3.0.5/JCVMSpec_3.0.5.pdf#page=162)
    # Source: [JCVM 3.1, s7.5.24 goto](../../refs/3.1/JCVMSpec_3.1.pdf#page=180)
    # Source: [JCVM 3.2, s7.5.24 goto](../../refs/3.2/JCVMSpec_3.2.pdf#page=180)
  ...
  Scenario: goto_w -- branch always (16-bit offset)
    # Source: [JCVM 3.0.5, s7.5.25 goto_w](../../refs/3.0.5/JCVMSpec_3.0.5.pdf#page=162)
    # Source: [JCVM 3.1, s7.5.25 goto_w](../../refs/3.1/JCVMSpec_3.1.pdf#page=181)
    # Source: [JCVM 3.2, s7.5.25 goto_w](../../refs/3.2/JCVMSpec_3.2.pdf#page=181)
  ...
  Scenario: if_scmpeq through if_scmple -- branch if short comparison succeeds (8-bit)
    # Source: [JCVM 3.0.5, s7.5.37 if_scmp<cond>](../../refs/3.0.5/JCVMSpec_3.0.5.pdf#page=170)
    # Source: [JCVM 3.1, s7.5.37 if_scmp<cond>](../../refs/3.1/JCVMSpec_3.1.pdf#page=189)
    # Source: [JCVM 3.2, s7.5.37 if_scmp<cond>](../../refs/3.2/JCVMSpec_3.2.pdf#page=189)
  ...
  Scenario: if_scmpeq_w through if_scmple_w -- branch if short comparison succeeds (16-bit)
    # Source: [JCVM 3.0.5, s7.5.38 if_scmp<cond>_w](../../refs/3.0.5/JCVMSpec_3.0.5.pdf#page=171)
    # Source: [JCVM 3.1, s7.5.38 if_scmp<cond>_w](../../refs/3.1/JCVMSpec_3.1.pdf#page=189)
    # Source: [JCVM 3.2, s7.5.38 if_scmp<cond>_w](../../refs/3.2/JCVMSpec_3.2.pdf#page=189)
  ...
  Scenario: if_acmpeq, if_acmpne -- branch if reference comparison succeeds (8-bit)
    # Source: [JCVM 3.0.5, s7.5.35 if_acmp<cond>](../../refs/3.0.5/JCVMSpec_3.0.5.pdf#page=169)
    # Source: [JCVM 3.1, s7.5.35 if_acmp<cond>](../../refs/3.1/JCVMSpec_3.1.pdf#page=187)
    # Source: [JCVM 3.2, s7.5.35 if_acmp<cond>](../../refs/3.2/JCVMSpec_3.2.pdf#page=187)
  ...
  Scenario: if_acmpeq_w, if_acmpne_w -- branch if reference comparison succeeds (16-bit)
    # Source: [JCVM 3.0.5, s7.5.36 if_acmp<cond>_w](../../refs/3.0.5/JCVMSpec_3.0.5.pdf#page=169)
    # Source: [JCVM 3.1, s7.5.36 if_acmp<cond>_w](../../refs/3.1/JCVMSpec_3.1.pdf#page=188)
    # Source: [JCVM 3.2, s7.5.36 if_acmp<cond>_w](../../refs/3.2/JCVMSpec_3.2.pdf#page=188)
  ...
  Scenario: ifeq through ifle -- branch if short comparison with zero succeeds (8-bit)
    # Source: [JCVM 3.0.5, s7.5.39 if<cond>](../../refs/3.0.5/JCVMSpec_3.0.5.pdf#page=172)
    # Source: [JCVM 3.1, s7.5.39 if<cond>](../../refs/3.1/JCVMSpec_3.1.pdf#page=190)
    # Source: [JCVM 3.2, s7.5.39 if<cond>](../../refs/3.2/JCVMSpec_3.2.pdf#page=190)
  ...
  Scenario: ifeq_w through ifle_w -- branch if short comparison with zero succeeds (16-bit)
    # Source: [JCVM 3.0.5, s7.5.40 if<cond>_w](../../refs/3.0.5/JCVMSpec_3.0.5.pdf#page=173)
    # Source: [JCVM 3.1, s7.5.40 if<cond>_w](../../refs/3.1/JCVMSpec_3.1.pdf#page=191)
    # Source: [JCVM 3.2, s7.5.40 if<cond>_w](../../refs/3.2/JCVMSpec_3.2.pdf#page=191)
  ...
  Scenario: ifnull -- branch if reference is null (8-bit offset)
    # Source: [JCVM 3.0.5, s7.5.43 ifnull](../../refs/3.0.5/JCVMSpec_3.0.5.pdf#page=175)
    # Source: [JCVM 3.1, s7.5.43 ifnull](../../refs/3.1/JCVMSpec_3.1.pdf#page=193)
    # Source: [JCVM 3.2, s7.5.43 ifnull](../../refs/3.2/JCVMSpec_3.2.pdf#page=193)
  ...
  Scenario: ifnull_w -- branch if reference is null (16-bit offset)
    # Source: [JCVM 3.0.5, s7.5.44 ifnull_w](../../refs/3.0.5/JCVMSpec_3.0.5.pdf#page=175)
    # Source: [JCVM 3.1, s7.5.44 ifnull_w](../../refs/3.1/JCVMSpec_3.1.pdf#page=194)
    # Source: [JCVM 3.2, s7.5.44 ifnull_w](../../refs/3.2/JCVMSpec_3.2.pdf#page=194)
  ...
  Scenario: ifnonnull -- branch if reference not null (8-bit offset)
    # Source: [JCVM 3.0.5, s7.5.41 ifnonnull](../../refs/3.0.5/JCVMSpec_3.0.5.pdf#page=174)
    # Source: [JCVM 3.1, s7.5.41 ifnonnull](../../refs/3.1/JCVMSpec_3.1.pdf#page=192)
    # Source: [JCVM 3.2, s7.5.41 ifnonnull](../../refs/3.2/JCVMSpec_3.2.pdf#page=192)
  ...
  Scenario: ifnonnull_w -- branch if reference not null (16-bit offset)
    # Source: [JCVM 3.0.5, s7.5.42 ifnonnull_w](../../refs/3.0.5/JCVMSpec_3.0.5.pdf#page=174)
    # Source: [JCVM 3.1, s7.5.42 ifnonnull_w](../../refs/3.1/JCVMSpec_3.1.pdf#page=193)
    # Source: [JCVM 3.2, s7.5.42 ifnonnull_w](../../refs/3.2/JCVMSpec_3.2.pdf#page=193)
  ...
  Scenario: slookupswitch -- access jump table by short key match
    # Source: [JCVM 3.0.5, s7.5.94 slookupswitch](../../refs/3.0.5/JCVMSpec_3.0.5.pdf#page=213)
    # Source: [JCVM 3.1, s7.5.94 slookupswitch](../../refs/3.1/JCVMSpec_3.1.pdf#page=233)
    # Source: [JCVM 3.2, s7.5.94 slookupswitch](../../refs/3.2/JCVMSpec_3.2.pdf#page=233)
  ...
  Scenario: stableswitch -- access jump table by short index
    # Source: [JCVM 3.0.5, s7.5.106 stableswitch](../../refs/3.0.5/JCVMSpec_3.0.5.pdf#page=220)
    # Source: [JCVM 3.1, s7.5.106 stableswitch](../../refs/3.1/JCVMSpec_3.1.pdf#page=240)
    # Source: [JCVM 3.2, s7.5.106 stableswitch](../../refs/3.2/JCVMSpec_3.2.pdf#page=240)
  ...
  Scenario: ilookupswitch -- access jump table by int key match
    # Source: [JCVM 3.0.5, s7.5.50 ilookupswitch](../../refs/3.0.5/JCVMSpec_3.0.5.pdf#page=179)
    # Source: [JCVM 3.1, s7.5.50 ilookupswitch](../../refs/3.1/JCVMSpec_3.1.pdf#page=197)
    # Source: [JCVM 3.2, s7.5.50 ilookupswitch](../../refs/3.2/JCVMSpec_3.2.pdf#page=197)
  ...
  Scenario: itableswitch -- access jump table by int index
    # Source: [JCVM 3.0.5, s7.5.66 itableswitch](../../refs/3.0.5/JCVMSpec_3.0.5.pdf#page=193)
    # Source: [JCVM 3.1, s7.5.66 itableswitch](../../refs/3.1/JCVMSpec_3.1.pdf#page=213)
    # Source: [JCVM 3.2, s7.5.66 itableswitch](../../refs/3.2/JCVMSpec_3.2.pdf#page=213)
  ...
  Scenario: jsr -- jump subroutine
    # Source: [JCVM 3.0.5, s7.5.69 jsr](../../refs/3.0.5/JCVMSpec_3.0.5.pdf#page=195)
    # Source: [JCVM 3.1, s7.5.69 jsr](../../refs/3.1/JCVMSpec_3.1.pdf#page=215)
    # Source: [JCVM 3.2, s7.5.69 jsr](../../refs/3.2/JCVMSpec_3.2.pdf#page=215)
  ...
  Scenario: ret -- return from subroutine
    # Source: [JCVM 3.0.5, s7.5.79 ret](../../refs/3.0.5/JCVMSpec_3.0.5.pdf#page=204)
    # Source: [JCVM 3.1, s7.5.79 ret](../../refs/3.1/JCVMSpec_3.1.pdf#page=224)
    # Source: [JCVM 3.2, s7.5.79 ret](../../refs/3.2/JCVMSpec_3.2.pdf#page=224)
