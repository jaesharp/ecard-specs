...
Feature: JCVM Type Conversion Bytecodes
  ...
  Scenario: s2b -- convert short to byte
    # Source: [JCVM 3.0.5, s7.5.81 s2b](../../../3.0.5/JCVMSpec_3.0.5.pdf#page=205)
    # Source: [JCVM 3.1, s7.5.81 s2b](../../../3.1/JCVMSpec_3.1.pdf#page=225)
    # Source: [JCVM 3.2, s7.5.81 s2b](../../../3.2/JCVMSpec_3.2.pdf#page=225)
  ...
  Scenario: s2i -- convert short to int
    # Source: [JCVM 3.0.5, s7.5.82 s2i](../../../3.0.5/JCVMSpec_3.0.5.pdf#page=206)
    # Source: [JCVM 3.1, s7.5.82 s2i](../../../3.1/JCVMSpec_3.1.pdf#page=226)
    # Source: [JCVM 3.2, s7.5.82 s2i](../../../3.2/JCVMSpec_3.2.pdf#page=226)
  ...
  Scenario: i2b -- convert int to byte
    # Source: [JCVM 3.0.5, s7.5.26 i2b](../../../3.0.5/JCVMSpec_3.0.5.pdf#page=163)
    # Source: [JCVM 3.1, s7.5.26 i2b](../../../3.1/JCVMSpec_3.1.pdf#page=181)
    # Source: [JCVM 3.2, s7.5.26 i2b](../../../3.2/JCVMSpec_3.2.pdf#page=181)
  ...
  Scenario: i2s -- convert int to short
    # Source: [JCVM 3.0.5, s7.5.27 i2s](../../../3.0.5/JCVMSpec_3.0.5.pdf#page=163)
    # Source: [JCVM 3.1, s7.5.27 i2s](../../../3.1/JCVMSpec_3.1.pdf#page=182)
    # Source: [JCVM 3.2, s7.5.27 i2s](../../../3.2/JCVMSpec_3.2.pdf#page=182)
