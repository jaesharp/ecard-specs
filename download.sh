...
mkdir -p docs/globalplatform docs/globalplatform/se-access-control \
         docs/javacard/2.1.1 docs/javacard/2.2.2 docs/javacard/3.0.5 docs/javacard/3.1 docs/javacard/3.2 \
         docs/ibm-jcop docs/iso docs/emv docs/research docs/reference-implementations
...
curl -z docs/globalplatform/GPC_CardSpecification_v2.1.1.pdf -sL -o docs/globalplatform/GPC_CardSpecification_v2.1.1.pdf \
  "https://pinpasjc.win.tue.nl/docs/Card%20Spec%20v2.1.1%20v0303.pdf"

# GP 2.2 (intermediate version, TU/e Eindhoven mirror)
curl -z docs/globalplatform/GPC_CardSpecification_v2.2.pdf -sL -o docs/globalplatform/GPC_CardSpecification_v2.2.pdf \
  "https://pinpasjc.win.tue.nl/docs/GPCardSpec_v2.2.pdf"

# GP 2.2.1 (intermediate version, direct from GlobalPlatform)
curl -z docs/globalplatform/GPC_CardSpecification_v2.2.1.pdf -sL -o docs/globalplatform/GPC_CardSpecification_v2.2.1.pdf \
...
curl -z docs/globalplatform/GPC_CardSpecification_v2.3.1.pdf -sL -o docs/globalplatform/GPC_CardSpecification_v2.3.1.pdf \
...
curl -z docs/globalplatform/GPC_2.3_D_SCP03_v1.1.2.pdf -sL -o docs/globalplatform/GPC_2.3_D_SCP03_v1.1.2.pdf \
...
curl -z docs/globalplatform/GP_2.1.1_Mapping_Guidelines.pdf -sL -o docs/globalplatform/GP_2.1.1_Mapping_Guidelines.pdf \
...
curl -z docs/globalplatform/GPC_2.2_Amendment_A_v1.0.1.pdf -sL -o docs/globalplatform/GPC_2.2_Amendment_A_v1.0.1.pdf \
...
curl -z docs/globalplatform/GPC_2.3_A_ConfidentialCCM_v1.2.pdf -sL -o docs/globalplatform/GPC_2.3_A_ConfidentialCCM_v1.2.pdf \
...
curl -z docs/globalplatform/GPC_2.2_B_RAM_over_HTTP_v1.1.3.pdf -sL -o docs/globalplatform/GPC_2.2_B_RAM_over_HTTP_v1.1.3.pdf \
...
curl -z docs/globalplatform/GPC_2.3_C_ContactlessServices_v1.2.pdf -sL -o docs/globalplatform/GPC_2.3_C_ContactlessServices_v1.2.pdf \
...
curl -z docs/globalplatform/GPC_2.3_E_SecurityUpgrade_v1.1.pdf -sL -o docs/globalplatform/GPC_2.3_E_SecurityUpgrade_v1.1.pdf \
...
curl -z docs/globalplatform/GPC_UICC_ContactlessExtn_v1.0.pdf -sL -o docs/globalplatform/GPC_UICC_ContactlessExtn_v1.0.pdf \
...
curl -z docs/globalplatform/se-access-control/GPD_SE_Access_Control_v1.1.pdf -sL -o docs/globalplatform/se-access-control/GPD_SE_Access_Control_v1.1.pdf \
...
if [ ! -f docs/javacard/2.1.1/JCVMSpec.pdf ]; then
  ...
  unzip -o -j /tmp/jc211-doc.zip "*/JCVMSpec.pdf" -d docs/javacard/2.1.1/
  unzip -o -j /tmp/jc211-doc.zip "*/JCRESpec.pdf" -d docs/javacard/2.1.1/
  unzip -o -j /tmp/jc211-doc.zip "*/JavaCard211API.pdf" -d docs/javacard/2.1.1/
  unzip -o -j /tmp/jc211-doc.zip "*/JC211SpecRelease.pdf" -d docs/javacard/2.1.1/
...
if [ ! -f docs/javacard/2.2.2/JavaCard222VMspec.pdf ]; then
  ...
  unzip -o -j /tmp/jc222-spec.zip "*/JavaCard222VMspec.pdf" -d docs/javacard/2.2.2/
  unzip -o -j /tmp/jc222-spec.zip "*/JavaCard222JCREspec.pdf" -d docs/javacard/2.2.2/
  unzip -o -j /tmp/jc222-spec.zip "*/JavaCard222API.pdf" -d docs/javacard/2.2.2/
...
if [ ! -f docs/javacard/3.0.5/JCVMSpec_3.0.5.pdf ]; then
  ...
  cp "$TMP_REPO/Java Card Specification  3.0.5.pdf" docs/javacard/3.0.5/JCVMSpec_3.0.5.pdf
  cp "$TMP_REPO/Javacard Runtime 3.0.5.pdf" docs/javacard/3.0.5/JCRESpec_3.0.5.pdf
  # Also grab 3.2 and developer guide while we have the repo
  cp "$TMP_REPO/Java Card Specification 3.2.pdf" docs/javacard/3.2/JCVMSpec_3.2.pdf 2>/dev/null || true
  cp "$TMP_REPO/Javacard Runtime 3.2.pdf" docs/javacard/3.2/JCRESpec_3.2.pdf 2>/dev/null || true
  cp "$TMP_REPO/Java Card Applet Developers Guide.pdf" docs/javacard/ 2>/dev/null || true
  rm -rf "$TMP_REPO"
fi

# JavaCard 3.1 VM Spec (latest, best normative clarity for ambiguous 2.1.1 behavior)
curl -z docs/javacard/3.1/JCVMSpec_3.1.pdf -sL -o docs/javacard/3.1/JCVMSpec_3.1.pdf \
  "https://docs.oracle.com/en/java/javacard/3.1/jc-vm-spec/F12650_05.pdf"

# JavaCard 3.1 JCRE Spec
curl -z docs/javacard/3.1/JCRESpec_3.1.pdf -sL -o docs/javacard/3.1/JCRESpec_3.1.pdf \
...
curl -z docs/ibm-jcop/JCOP_Family.pdf -sL -o docs/ibm-jcop/JCOP_Family.pdf \
  "https://public.dhe.ibm.com/software/pervasive/info/JCOP_Family.pdf"

curl -z docs/ibm-jcop/JCOP10Brief.pdf -sL -o docs/ibm-jcop/JCOP10Brief.pdf \
  "https://public.dhe.ibm.com/software/pervasive/info/JCOP10Brief.pdf"

curl -z docs/ibm-jcop/JCOP20Brief.pdf -sL -o docs/ibm-jcop/JCOP20Brief.pdf \
...
curl -z docs/emv/EMV_v4.3_Book_3_Application_Specification.pdf -sL -o docs/emv/EMV_v4.3_Book_3_Application_Specification.pdf \
...
curl -z docs/emv/EMV_v4.3_Book_4_Other_Interfaces.pdf -sL -o docs/emv/EMV_v4.3_Book_4_Other_Interfaces.pdf \
...
curl -z docs/iso/iso14443-reference-NXP-AN10834.pdf -sL -o docs/iso/iso14443-reference-NXP-AN10834.pdf \
...
curl -z docs/research/2023-cardis-javacard.pdf -sL -o docs/research/2023-cardis-javacard.pdf \
  "https://crocs.fi.muni.cz/_media/publications/pdf/2023-cardis-javacard.pdf"

# Curated JavaCard applet list (crocs-muni)
curl -z docs/research/javacard-curated-list.md -sL -o docs/research/javacard-curated-list.md \
...
find docs -type f \( -name "*.pdf" -o -name "*.md" \) -not -path "./.git/*" | sort | while read -r f; do
  printf "  %8s  %s\n" "$(stat -c%s "$f" | numfmt --to=iec)" "$f"
done
echo ""
echo "Total PDFs: $(find docs -name '*.pdf' -not -path './.git/*' | wc -l)"
echo "Done."
