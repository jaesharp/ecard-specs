...
Feature: JCVM Language and Bytecode Subset
  ...
  # Source: [JCVM 3.0.5, s2 A Subset of the Java Virtual Machine](../refs/3.0.5/JCVMSpec_3.0.5.pdf#page=27)
  # Source: [JCVM 3.1, s2 A Subset of the Java Virtual Machine](../refs/3.1/JCVMSpec_3.1.pdf#page=27)
  # Source: [JCVM 3.2, s2 A Subset of the Java Virtual Machine](../refs/3.2/JCVMSpec_3.2.pdf#page=27)
  Background:
  ...
  Scenario: Dynamic class loading is not supported
    # Source: [JCVM 3.0.5, s2.2.1.1.1](../refs/3.0.5/JCVMSpec_3.0.5.pdf#page=27)
    # Source: [JCVM 3.2, s2.2.1.1.1](../refs/3.2/JCVMSpec_3.2.pdf#page=27)
  ...
  Scenario: Security Manager class is not supported
    # Source: [JCVM 3.0.5, s2.2.1.1.2](../refs/3.0.5/JCVMSpec_3.0.5.pdf#page=28)
    # Source: [JCVM 3.2, s2.2.1.1.2](../refs/3.2/JCVMSpec_3.2.pdf#page=28)
  ...
  Scenario: Finalization, threads, and cloning are not supported
    # Source: [JCVM 3.0.5, s2.2.1.1.3-5](../refs/3.0.5/JCVMSpec_3.0.5.pdf#page=28)
    # Source: [JCVM 3.2, s2.2.1.1.3-5](../refs/3.2/JCVMSpec_3.2.pdf#page=28)
  ...
  Scenario: Typesafe enums, enhanced for loop, varargs are not supported
    # Source: [JCVM 3.0.5, s2.2.1.1.7-9](../refs/3.0.5/JCVMSpec_3.0.5.pdf#page=28)
    # Source: [JCVM 3.2, s2.2.1.1.7-9](../refs/3.2/JCVMSpec_3.2.pdf#page=28)
  ...
  Scenario: Unsupported Java keywords
    # Source: [JCVM 3.0.5, s2.2.1.2](../refs/3.0.5/JCVMSpec_3.0.5.pdf#page=29)
    # Source: [JCVM 3.2, s2.2.1.2](../refs/3.2/JCVMSpec_3.2.pdf#page=29)
  ...
  Scenario: Unsupported Java types
    # Source: [JCVM 3.0.5, s2.2.1.3](../refs/3.0.5/JCVMSpec_3.0.5.pdf#page=29)
    # Source: [JCVM 3.2, s2.2.1.3](../refs/3.2/JCVMSpec_3.2.pdf#page=29)
  ...
  Scenario: Supported language features
    # Source: [JCVM 3.0.5, s2.2.2.1](../refs/3.0.5/JCVMSpec_3.0.5.pdf#page=30)
    # Source: [JCVM 3.2, s2.2.2.1](../refs/3.2/JCVMSpec_3.2.pdf#page=30)
  ...
  Scenario: Supported types
    # Source: [JCVM 3.0.5, s2.2.2.3](../refs/3.0.5/JCVMSpec_3.0.5.pdf#page=32)
    # Source: [JCVM 3.2, s2.2.2.3](../refs/3.2/JCVMSpec_3.2.pdf#page=32)
  ...
  Scenario: Supported classes from java.lang
    # Source: [JCVM 3.0.5, s2.2.2.4](../refs/3.0.5/JCVMSpec_3.0.5.pdf#page=32)
    # Source: [JCVM 3.2, s2.2.2.4](../refs/3.2/JCVMSpec_3.2.pdf#page=32)
  ...
  Scenario: Integer data type is optionally supported
    # Source: [JCVM 3.0.5, s2.2.3.1](../refs/3.0.5/JCVMSpec_3.0.5.pdf#page=33)
    # Source: [JCVM 3.2, s2.2.3.1](../refs/3.2/JCVMSpec_3.2.pdf#page=33)
  ...
  Scenario: Object deletion mechanism is optionally supported
    # Source: [JCVM 3.0.5, s2.2.3.2](../refs/3.0.5/JCVMSpec_3.0.5.pdf#page=33)
    # Source: [JCVM 3.2, s2.2.3.2](../refs/3.2/JCVMSpec_3.2.pdf#page=33)
  ...
  Scenario: Limitations of packages
    # Source: [JCVM 3.0.5, s2.2.4.1](../refs/3.0.5/JCVMSpec_3.0.5.pdf#page=33)
    # Source: [JCVM 3.2, s2.2.4.1](../refs/3.2/JCVMSpec_3.2.pdf#page=33)
  ...
  Scenario: Limitations of classes
    # Source: [JCVM 3.0.5, s2.2.4.2](../refs/3.0.5/JCVMSpec_3.0.5.pdf#page=33)
    # Source: [JCVM 3.2, s2.2.4.2](../refs/3.2/JCVMSpec_3.2.pdf#page=34)
  ...
  Scenario: Limitations of objects
    # Source: [JCVM 3.0.5, s2.2.4.3](../refs/3.0.5/JCVMSpec_3.0.5.pdf#page=34)
    # Source: [JCVM 3.2, s2.2.4.3](../refs/3.2/JCVMSpec_3.2.pdf#page=34)
  ...
  Scenario: Limitations of methods
    # Source: [JCVM 3.0.5, s2.2.4.4](../refs/3.0.5/JCVMSpec_3.0.5.pdf#page=34)
    # Source: [JCVM 3.2, s2.2.4.4](../refs/3.2/JCVMSpec_3.2.pdf#page=34)
  ...
  Scenario: Unsupported Java bytecodes (all long, float, double, char, thread, and multi-array)
    # Source: [JCVM 3.0.5, s2.3.2.1 Unsupported Bytecodes](../refs/3.0.5/JCVMSpec_3.0.5.pdf#page=38)
    # Source: [JCVM 3.2, s2.3.2.1](../refs/3.2/JCVMSpec_3.2.pdf#page=38)
  ...
  Scenario: Static restrictions on bytecodes
    # Source: [JCVM 3.0.5, s2.3.2.3](../refs/3.0.5/JCVMSpec_3.0.5.pdf#page=42)
    # Source: [JCVM 3.2, s2.3.2.3](../refs/3.2/JCVMSpec_3.2.pdf#page=42)
  ...
  Scenario: Supported runtime exceptions
    # Source: [JCVM 3.0.5, s2.3.3.3 Table 2-4](../refs/3.0.5/JCVMSpec_3.0.5.pdf#page=43)
    # Source: [JCVM 3.2, s2.3.3.3 Table 2-4](../refs/3.2/JCVMSpec_3.2.pdf#page=44)
  ...
  Scenario: Supported errors
    # Source: [JCVM 3.0.5, s2.3.3.4 Table 2-5](../refs/3.0.5/JCVMSpec_3.0.5.pdf#page=44)
    # Source: [JCVM 3.2, s2.3.3.4 Table 2-5](../refs/3.2/JCVMSpec_3.2.pdf#page=44)
