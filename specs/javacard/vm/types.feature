...
Feature: JCVM Data Types and Values
  ...
  # Source: [JCVM 3.0.5, s3.1 Data Types and Values](../refs/3.0.5/JCVMSpec_3.0.5.pdf#page=46)
  # Source: [JCVM 3.1, s3.1 Data Types and Values](../refs/3.1/JCVMSpec_3.1.pdf#page=46)
  # Source: [JCVM 3.2, s3.1 Data Types and Values](../refs/3.2/JCVMSpec_3.2.pdf#page=46)
  Background:
  ...
  Scenario: byte type -- 8-bit signed two's complement integer
    # Source: [JCVM 3.0.5, s3.1](../refs/3.0.5/JCVMSpec_3.0.5.pdf#page=46)
    # Source: [JCVM 3.1, s3.1](../refs/3.1/JCVMSpec_3.1.pdf#page=46)
    # Source: [JCVM 3.2, s3.1](../refs/3.2/JCVMSpec_3.2.pdf#page=46)
  ...
  Scenario: word -- abstract storage unit for one-word values
    # Source: [JCVM 3.0.5, s3.2 Words](../refs/3.0.5/JCVMSpec_3.0.5.pdf#page=46)
    # Source: [JCVM 3.1, s3.2 Words](../refs/3.1/JCVMSpec_3.1.pdf#page=46)
    # Source: [JCVM 3.2, s3.2 Words](../refs/3.2/JCVMSpec_3.2.pdf#page=46)
  ...
  Scenario: storage type byte maps to computational type short
    # Source: [JCVM 3.0.5, s3.10.1 Table 3-2](../refs/3.0.5/JCVMSpec_3.0.5.pdf#page=50)
    # Source: [JCVM 3.1, s3.10.1 Table 3-2](../refs/3.1/JCVMSpec_3.1.pdf#page=50)
    # Source: [JCVM 3.2, s3.10.1 Table 3-2](../refs/3.2/JCVMSpec_3.2.pdf#page=50)
  ...
  Scenario: single thread of execution
    # Source: [JCVM 3.0.5, s3.3 Runtime Data Areas](../refs/3.0.5/JCVMSpec_3.0.5.pdf#page=47)
    # Source: [JCVM 3.1, s3.3 Runtime Data Areas](../refs/3.1/JCVMSpec_3.1.pdf#page=47)
    # Source: [JCVM 3.2, s3.3 Runtime Data Areas](../refs/3.2/JCVMSpec_3.2.pdf#page=47)
  ...
  Scenario: heap is not required to be garbage collected
    # Source: [JCVM 3.0.5, s3.3](../refs/3.0.5/JCVMSpec_3.0.5.pdf#page=47)
    # Source: [JCVM 3.1, s3.3](../refs/3.1/JCVMSpec_3.1.pdf#page=47)
    # Source: [JCVM 3.2, s3.3](../refs/3.2/JCVMSpec_3.2.pdf#page=47)
  ...
  Scenario: stack frames contain local variables, operand stack, and constant pool reference
    # Source: [JCVM 3.0.5, s3.5 Frames](../refs/3.0.5/JCVMSpec_3.0.5.pdf#page=47)
    # Source: [JCVM 3.1, s3.5 Frames](../refs/3.1/JCVMSpec_3.1.pdf#page=47)
    # Source: [JCVM 3.2, s3.5 Frames](../refs/3.2/JCVMSpec_3.2.pdf#page=47)
  ...
  Scenario: instructions are one-byte opcode plus zero or more operands
    # Source: [JCVM 3.0.5, s3.10](../refs/3.0.5/JCVMSpec_3.0.5.pdf#page=48)
    # Source: [JCVM 3.1, s3.10](../refs/3.1/JCVMSpec_3.1.pdf#page=48)
    # Source: [JCVM 3.2, s3.10](../refs/3.2/JCVMSpec_3.2.pdf#page=48)
  ...
  Scenario: no direct byte-type arithmetic instructions
    # Source: [JCVM 3.0.5, s3.10.1 Table 3-1](../refs/3.0.5/JCVMSpec_3.0.5.pdf#page=49)
    # Source: [JCVM 3.1, s3.10.1 Table 3-1](../refs/3.1/JCVMSpec_3.1.pdf#page=49)
    # Source: [JCVM 3.2, s3.10.1 Table 3-1](../refs/3.2/JCVMSpec_3.2.pdf#page=49)
