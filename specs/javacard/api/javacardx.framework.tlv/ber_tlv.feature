...
Feature: BER-TLV -- Tag-Length-Value Framework (BERTag, BERTLV, Constructed/Primitive variants, TLVException)
  ...
  # Source: [JavaCard 3.2 API, tlv package](../../refs/javadoc-3.2/api_classic/javacardx/framework/tlv/package-summary.html)
  Background:
  ...
  # Source: [JavaCard 3.2 API, BERTag](../../refs/javadoc-3.2/api_classic/javacardx/framework/tlv/BERTag.html)
  ...
  # Source: [JavaCard 3.2 API, getInstance](../../refs/javadoc-3.2/api_classic/javacardx/framework/tlv/BERTag.html#getInstance(byte%5B%5D,short))
  ...
  # Source: [JavaCard 3.2 API, init](../../refs/javadoc-3.2/api_classic/javacardx/framework/tlv/PrimitiveBERTag.html#init(short,byte))
  ...
  # Source: [JavaCard 3.2 API, init](../../refs/javadoc-3.2/api_classic/javacardx/framework/tlv/PrimitiveBERTag.html#init(byte%5B%5D,short))
  # ========== ConstructedBERTag ==========
  ...
  # Source: [JavaCard 3.2 API, init](../../refs/javadoc-3.2/api_classic/javacardx/framework/tlv/ConstructedBERTag.html#init(short,byte))
  ...
  # Source: [JavaCard 3.2 API, init](../../refs/javadoc-3.2/api_classic/javacardx/framework/tlv/ConstructedBERTag.html#init(byte%5B%5D,short))
  # ========== BERTLV ==========
  ...
  # Source: [JavaCard 3.2 API, getInstance](../../refs/javadoc-3.2/api_classic/javacardx/framework/tlv/BERTLV.html#getInstance(byte%5B%5D,short,short))
  ...
  # Source: [JavaCard 3.2 API, BERTLV](../../refs/javadoc-3.2/api_classic/javacardx/framework/tlv/BERTLV.html)
  ...
  # Source: [JavaCard 3.2 API, PrimitiveBERTLV](../../refs/javadoc-3.2/api_classic/javacardx/framework/tlv/PrimitiveBERTLV.html)
  ...
  # Source: [JavaCard 3.2 API, appendValue](../../refs/javadoc-3.2/api_classic/javacardx/framework/tlv/PrimitiveBERTLV.html#appendValue(byte%5B%5D,short,byte%5B%5D,short,short))
  # ========== ConstructedBERTLV ==========
  ...
  # Source: [JavaCard 3.2 API, ConstructedBERTLV](../../refs/javadoc-3.2/api_classic/javacardx/framework/tlv/ConstructedBERTLV.html)
  ...
  Scenario Outline: TLVException defines reason codes
    ...
    # Source: [JavaCard 3.2 API, <constant>](../../refs/javadoc-3.2/api_classic/javacardx/framework/tlv/TLVException.html)
    Examples:
      | constant                      |
      | INVALID_PARAM                 |
      | ILLEGAL_SIZE                  |
