...
Feature: Biometry 1:N -- BioMatcher, BioTemplateData, and Supporting Classes
  ...
  # Source: [JavaCard 3.2 API, biometry1toN package](../.refs/javadoc-3.2/api_classic/javacardx/biometry1toN/package-summary.html)
  Background:
  ...
  Scenario Outline: Bio1toNBuilder defines biometric type constants
    ...
    # Source: [JavaCard 3.2 API, Bio1toNBuilder](../.refs/javadoc-3.2/api_classic/javacardx/biometry1toN/Bio1toNBuilder.html)
    Examples:
      | constant        |
      | FACIAL_FEATURE  |
      | VOICE_PRINT     |
  ...
  # Source: [JavaCard 3.2 API, buildBioMatcher](../.refs/javadoc-3.2/api_classic/javacardx/biometry1toN/Bio1toNBuilder.html#buildBioMatcher(byte,byte,short))
  ...
  # Source: [JavaCard 3.2 API, buildBioTemplateData](../.refs/javadoc-3.2/api_classic/javacardx/biometry1toN/Bio1toNBuilder.html#buildBioTemplateData(byte))
  ...
  # Source: [JavaCard 3.2 API, isInitialized](../.refs/javadoc-3.2/api_classic/javacardx/biometry1toN/BioMatcher.html#isInitialized)
  ...
  # Source: [JavaCard 3.2 API, isValidated](../.refs/javadoc-3.2/api_classic/javacardx/biometry1toN/BioMatcher.html#isValidated)
  Scenario: BioMatcher.reset clears validation state
    Given a validated BioMatcher
    When reset() is called
    Then isValidated returns false

  # Source: [JavaCard 3.2 API, reset](../.refs/javadoc-3.2/api_classic/javacardx/biometry1toN/BioMatcher.html#reset)
  ...
  # Source: [JavaCard 3.2 API, getTriesRemaining](../.refs/javadoc-3.2/api_classic/javacardx/biometry1toN/BioMatcher.html#getTriesRemaining)
  ...
  # Source: [JavaCard 3.2 API, getBioType](../.refs/javadoc-3.2/api_classic/javacardx/biometry1toN/BioMatcher.html#getBioType)
  ...
  # Source: [JavaCard 3.2 API, initMatch](../.refs/javadoc-3.2/api_classic/javacardx/biometry1toN/BioMatcher.html#initMatch(byte%5B%5D,short,short))
  ...
  # Source: [JavaCard 3.2 API, match](../.refs/javadoc-3.2/api_classic/javacardx/biometry1toN/BioMatcher.html#match(byte%5B%5D,short,short))
  ...
  # Source: [JavaCard 3.2 API, getMaxNbOfBioTemplateData](../.refs/javadoc-3.2/api_classic/javacardx/biometry1toN/BioMatcher.html#getMaxNbOfBioTemplateData)
  ...
  # Source: [JavaCard 3.2 API, getIndexOfLastMatchingBioTemplateData](../.refs/javadoc-3.2/api_classic/javacardx/biometry1toN/BioMatcher.html#getIndexOfLastMatchingBioTemplateData)
  ...
  # Source: [JavaCard 3.2 API, getBioTemplateData](../.refs/javadoc-3.2/api_classic/javacardx/biometry1toN/BioMatcher.html#getBioTemplateData(short))
  ...
  # Source: [JavaCard 3.2 API, BioMatcher](../.refs/javadoc-3.2/api_classic/javacardx/biometry1toN/BioMatcher.html)
  ...
  # Source: [JavaCard 3.2 API, putBioTemplateData](../.refs/javadoc-3.2/api_classic/javacardx/biometry1toN/OwnerBioMatcher.html#putBioTemplateData(short,BioTemplateData))
  ...
  # Source: [JavaCard 3.2 API, resetUnblockAndSetTryLimit](../.refs/javadoc-3.2/api_classic/javacardx/biometry1toN/OwnerBioMatcher.html#resetUnblockAndSetTryLimit(byte))
  ...
  # Source: [JavaCard 3.2 API, getBioType](../.refs/javadoc-3.2/api_classic/javacardx/biometry1toN/BioTemplateData.html#getBioType)
  ...
  # Source: [JavaCard 3.2 API, isInitialized](../.refs/javadoc-3.2/api_classic/javacardx/biometry1toN/BioTemplateData.html#isInitialized)
  ...
  # Source: [JavaCard 3.2 API, getPublicData](../.refs/javadoc-3.2/api_classic/javacardx/biometry1toN/BioTemplateData.html#getPublicData(short,byte%5B%5D,short,short))
  ...
  # Source: [JavaCard 3.2 API, OwnerBioTemplateData](../.refs/javadoc-3.2/api_classic/javacardx/biometry1toN/OwnerBioTemplateData.html)
  ...
  # Source: [JavaCard 3.2 API, clear](../.refs/javadoc-3.2/api_classic/javacardx/biometry1toN/OwnerBioTemplateData.html#clear)
  ...
  # Source: [JavaCard 3.2 API, SharedBioMatcher](../.refs/javadoc-3.2/api_classic/javacardx/biometry1toN/SharedBioMatcher.html)
  ...
  # Source: [JavaCard 3.2 API, SharedBioTemplateData](../.refs/javadoc-3.2/api_classic/javacardx/biometry1toN/SharedBioTemplateData.html)
  # ========== Bio1toNException ==========
  Scenario Outline: Bio1toNException defines reason codes
    Then class Bio1toNException defines static short constant "<constant>"

    # Source: [JavaCard 3.2 API, <constant>](../.refs/javadoc-3.2/api_classic/javacardx/biometry1toN/Bio1toNException.html)
    Examples:
      | constant                            |
      | ILLEGAL_VALUE                       |
      | INVALID_DATA                        |
