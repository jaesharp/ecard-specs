...
Feature: MonotonicCounter -- Persistent Monotonically Increasing Counter
  ...
  # Source: [JavaCard 3.2 API, MonotonicCounter](../../../../.refs/javadoc-3.2/api_classic/javacardx/security/util/MonotonicCounter.html)
  Background:
  ...
  # Source: [JavaCard 3.2 API, getInstance](../../../../.refs/javadoc-3.2/api_classic/javacardx/security/util/MonotonicCounter.html#getInstance(short,byte))
  # ========== Query Methods ==========
  ...
  # Source: [JavaCard 3.2 API, getMemoryType](../../../../.refs/javadoc-3.2/api_classic/javacardx/security/util/MonotonicCounter.html#getMemoryType)
  ...
  # Source: [JavaCard 3.2 API, getSize](../../../../.refs/javadoc-3.2/api_classic/javacardx/security/util/MonotonicCounter.html#getSize)
  # ========== Value Operations ==========
  ...
  # Source: [JavaCard 3.2 API, setValue](../../../../.refs/javadoc-3.2/api_classic/javacardx/security/util/MonotonicCounter.html#setValue(byte%5B%5D,short,short))
  ...
  # Source: [JavaCard 3.2 API, get](../../../../.refs/javadoc-3.2/api_classic/javacardx/security/util/MonotonicCounter.html#get(byte%5B%5D,short))
  ...
  # Source: [JavaCard 3.2 API, incrementBy](../../../../.refs/javadoc-3.2/api_classic/javacardx/security/util/MonotonicCounter.html#incrementBy(short))
  # ========== Comparison ==========
  ...
  # Source: [JavaCard 3.2 API, compareTo](../../../../.refs/javadoc-3.2/api_classic/javacardx/security/util/MonotonicCounter.html#compareTo(byte%5B%5D,short,short))
  ...
  # Source: [JavaCard 3.2 API, compareTo](../../../../.refs/javadoc-3.2/api_classic/javacardx/security/util/MonotonicCounter.html#compareTo(MonotonicCounter))
