...
Feature: SensitiveResult -- Secure Result Assertion
  ...
  # Source: [JavaCard 3.2 API, SensitiveResult](../../../.refs/javadoc-3.2/api_classic/javacardx/security/SensitiveResult.html)
  Background:
  ...
  # Source: [JavaCard 3.2 API, assertEquals](../../../.refs/javadoc-3.2/api_classic/javacardx/security/SensitiveResult.html#assertEquals(short,short))
  ...
  # Source: [JavaCard 3.2 API, assertTrue](../../../.refs/javadoc-3.2/api_classic/javacardx/security/SensitiveResult.html#assertTrue)
  ...
  # Source: [JavaCard 3.2 API, assertFalse](../../../.refs/javadoc-3.2/api_classic/javacardx/security/SensitiveResult.html#assertFalse)
  ...
  # Source: [JavaCard 3.2 API, assertNegative](../../../.refs/javadoc-3.2/api_classic/javacardx/security/SensitiveResult.html#assertNegative)
  ...
  # Source: [JavaCard 3.2 API, assertPositive](../../../.refs/javadoc-3.2/api_classic/javacardx/security/SensitiveResult.html#assertPositive)
  ...
  # Source: [JavaCard 3.2 API, assertZero](../../../.refs/javadoc-3.2/api_classic/javacardx/security/SensitiveResult.html#assertZero)
  ...
  # Source: [JavaCard 3.2 API, assertGreaterThan](../../../.refs/javadoc-3.2/api_classic/javacardx/security/SensitiveResult.html#assertGreaterThan(short))
  ...
  # Source: [JavaCard 3.2 API, assertLessThan](../../../.refs/javadoc-3.2/api_classic/javacardx/security/SensitiveResult.html#assertLessThan(short))
